...
function msData(e,n,o,t,r){var a=this;function s(e){e=firebase.database().ref(e);return n(e)}return a.data={power:{isOn:s("Engagments/"+o.engmntId+"/power/isOn"),source:s("Engagments/"+o.engmntId+"/power/source"),txs:s("Engagments/"+o.engmntId+"/power/txs")},production:{report:function(){const e="ProductionReports/"+o.engmntId,t=firebase.database(),r=t.ref(e),a=n(r);{if(null!=n&&null!=n.$value)return console.log("found a record"),a;console.log("creating a record")}}(o.engmntId)}},a.templates={prodReport:{ondeck:{},cooking:{},cooling:{},engagmentId:"",channelName:"",channelId:"",yrWk:0,status:"",journalEntries:{},acctsMap:{}}},a.models={operations:{0:{type:"recipe",recipe:"Sweet & Salty",nut:"Pecans",startAt:"",endAt:""},1:{type:"recipe",recipe:"Sweet & Salty",nut:"Almonds",startAt:"",endAt:""},2:{type:"recipe",recipe:"Sweet & Salty",nut:"Cashews",startAt:"",endAt:""},3:{type:"recipe",recipe:"Sweet & Salty",nut:"Hazelnuts",startAt:"",endAt:""},4:{type:"recipe",recipe:"Bourbon",nut:"Pecans",startAt:"",endAt:""},5:{type:"recipe",recipe:"Bourbon",nut:"Almonds",startAt:"",endAt:""},6:{type:"recipe",recipe:"Bourbon",nut:"Cashews",startAt:"",endAt:""},7:{type:"recipe",recipe:"Bourbon",nut:"Hazelnuts",startAt:"",endAt:""},8:{type:"oprtns",proces:"warming",startAt:"",endAt:""},9:{type:"oprtns",proces:"cleaning",startAt:"",endAt:""},10:{type:"oprtns",proces:"off",startAt:"",endAt:""},11:{type:"errors",proces:"burnt",startAt:"",endAt:""}}},{data:a.data,models:a.models,templates:a.templates,power:{togglePower:function(){console.log("toggling power"),a.data.power.isOn.$value=!a.data.power.isOn.$value;var e=r().format();a.data.power.txs[r().format("x")]={timestamp:e,source:a.data.power.source.$value,turningOn:a.data.power.isOn.$value},a.data.power.isOn.$save(),a.data.power.txs.$save(),t.$broadcast("powerTxsLoaded",a.data.power.txs)}}}}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","$rootScope","moment"];
...
function config(e,t){t.hashPrefix(""),e.when("/",{redirectTo:"/member"}).when("/login",{templateUrl:"assets/views/login-page.htm",controller:"loginController",controllerAs:"vm"}).when("/member",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var r=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid):n.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var r=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid):n.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid/settings",{templateUrl:"assets/views/acct-settings-page.htm",controller:"acctSettingsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var r=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/settings"):n.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid/txs_assignments",{templateUrl:"assets/views/txs-assigments-page.htm",controller:"txsAssigmentsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var r=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/txs_assignments"):n.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid/activities",{templateUrl:"assets/views/activities-page.htm",controller:"activitiesController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var r=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/activities"):n.path("/login"),r.resolve()}),r.promise}]}}).when("/minishop/:engmntId",{templateUrl:"assets/views/minishop/mdashboard-page.htm",controller:"minishopDashController",controllerAs:"vm"}).when("/minishop/:engmntId/settings",{templateUrl:"assets/views/minishop/settings-page.htm",controller:"minishopStngsController",controllerAs:"vm"}).when("/minishop/:engmntId/production",{templateUrl:"assets/views/minishop/production-page.htm",controller:"minishopProductionController",controllerAs:"vm"}).when("/minishop/:engmntId/salesTxs",{templateUrl:"assets/views/minishop/sales-txs-page.htm",controller:"minishopSalesTxsController",controllerAs:"vm"}).when("/minishop/:engmntId/balanceSheet",{templateUrl:"assets/views/minishop/balancesheet-page.htm",controller:"minishopBalancesheetController",controllerAs:"vm"}).when("/minishop/:engmntId/power",{templateUrl:"assets/views/minishop/power-source-page.htm",controller:"minishopPowerSourceController",controllerAs:"vm"}).when("/admin/channels",{templateUrl:"assets/views/admin-channels-page.htm",controller:"adminChannelsController",controllerAs:"vm"}).when("/admin/channels/:channelId",{templateUrl:"assets/views/admin-select-channel-page.htm",controller:"adminSelectChannelController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,t,n){var r=t.defer();return e.get.channelEngagments(n.current.params.channelId).then(function(e){console.log("got this",e),r.resolve(e)}),r.promise}]}}).when("/admin/engagments/:engagmentId",{templateUrl:"assets/views/admin-select-engagment-page.htm",controller:"adminSelectEngagmentController",controllerAs:"vm"}).when("/admin/schedule/weekly",{templateUrl:"assets/views/admin-weekly-schedule-page.htm",controller:"adminWeeklyScheduleController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,t,n){console.log("routing: ",n.current.params.Wk);var r=t.defer();return e.get.weeklyEngagments(n.current.params.Wk).then(function(e){console.log("got this",e),r.resolve(e)}),r.promise}]}}).when("/admin/fundsAllocations/daily",{templateUrl:"assets/views/admin-funds-allocations-daily-page.htm",controller:"adminFundsAllocationsDailyController",controllerAs:"vm"}).when("/admin/accts",{templateUrl:"assets/views/admin-accts-manage-page.htm",controller:"adminAcctsManageController",controllerAs:"vm"}).otherwise({redirectTo:"/"})}config.$inject=["$routeProvider","$locationProvider"],angular.module("ckc").config(config);
...
function minishopProductionController(o,e,t,n,c,i){let s=this;function r(){"Cooking"==s.cookingMetrics.status&&(s.cookingMetrics.timeElapsed++,function(){var o=i(s.cookingMetrics.startngTime);const e=i();o=100*(i.duration(e.diff(o)).as("seconds")/1200).toFixed(2),s.cookingMetrics.prcntPrgs=o}())}s.recipes=function(e){const t={};return Object.keys(e).forEach(function(o){"recipe"==e[o].type&&(t[o]=e[o])}),t}(c.models.operations),s.batches={ondeck:{},cooking:{},cooling:{}},s.cookingMetrics={startngTime:"",expiresAt:"",timeElapsed:0,status:"Off",prcntPrgs:0},s.selectRecipe=function(o){var e=null==s.batches.ondeck.recipe,t=s.batches.ondeck.recipe==s.recipes[o].recipe&&s.batches.ondeck.nut==s.recipes[o].nut;(!e||t)&&(e||t)?!e&&t&&(s.batches.ondeck={}):s.batches.ondeck=s.recipes[o]},s.startNewBatch=function(){null!=s.batches.ondeck.recipe?(console.log("starting a new batch"),s.batches.cooling=s.batches.cooking,s.batches.cooking=s.batches.ondeck,s.cookingMetrics.status="Cooking",s.cookingMetrics.startngTime=i().format(),s.cookingMetrics.timeElapsed=0,s.batches.ondeck={}):console.log("ned to select a batch first")},s.calculateCookingDone=function(o){if(""==o)return"";{const e=i(o);return e.add(12,"minutes").format("h:mm a")+" - "+e.add(16,"minutes").format("h:mm a")}},s.calculateCookingError=function(o){},console.log("in the miniship production controller "),e(function(){r()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$routeParams","$interval","$scope","$window","msData","moment"];
