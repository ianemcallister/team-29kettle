...
function minishopProductionController(e,n,o,t,c,i){let r=this;r.recipes=[{recipe:"Sweet & Salty",nut:"Pecans"},{recipe:"Sweet & Salty",nut:"Almonds"},{recipe:"Sweet & Salty",nut:"Cashews"},{recipe:"Sweet & Salty",nut:"Hazelnuts"},{recipe:"Bourbon",nut:"Pecans"},{recipe:"Bourbon",nut:"Almonds"},{recipe:"Bourbon",nut:"Cashews"},{recipe:"Bourbon",nut:"Hazelnuts"}],r.batches={ondeck:{},cooking:{},finsihed:{}},r.selectRecipe=function(e){var n=null==r.batches.ondeck.recipe,o=r.batches.ondeck.recipe==r.recipes[e].recipe&&r.batches.ondeck.nut==r.recipes[e].nut;(!n||o)&&(n||o)?!n&&o&&(r.batches.ondeck={}):r.batches.ondeck=r.recipes[e]},console.log("in the miniship production controller "),n(function(){},1e4)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$routeParams","$interval","$scope","$window","msData","moment"];
