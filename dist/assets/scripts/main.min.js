...
function txsAssigmentsController(){console.log("in the txsAssigmentsController  controller ")}ckc.controller("txsAssigmentsController",txsAssigmentsController),txsAssigmentsController.$inject=[];
...
function msData(e,r,t,n,a,d,s){var o=this;function i(e){e=firebase.database().ref(e);return r(e)}function c(e,t){a.defer();const n=firebase.database();e=n.ref("ProductionReports/"+e);return r(e)}function p(){return d().format("x")}return o.templates={prodReport:{ondeck:{_hold:""},cooking:{_hold:""},cooling:{_hold:""},engagmentId:"",channelName:"",channelId:"",yrWk:0,status:"",journalEntries:{_hold:""},ledgersMap:{_hold:""},lastStatus:"Off"},cookingJE:{id:"",startAt:"",endedAt:"",type:"cooking",recipe:"",nut:"",engagmentId:"",channelId:"",channelName:"",yrwk:"",teamMembrId:"",teamMemName:"",temperature:0,wind:"",powerSource:"",BoMId:"",isComplete:!1,txs:{}},cookingTx:{journalEntryId:"",ledgerId:"",createdAt:"",updatedAt:"",createdBy:"",updatedBy:"",debit:0,credit:0,description:"",engagmentId:"",channelName:"",channelId:""}},o.data={power:{isOn:i("Engagments/"+t.engmntId+"/power/isOn"),source:i("Engagments/"+t.engmntId+"/power/source"),txs:i("Engagments/"+t.engmntId+"/power/txs")},production:{report:c(t.engmntId,t.channelId)}},o.models={operations:{0:{type:"recipe",recipe:"Sweet & Salty",nut:"Pecans",startAt:"",endAt:"",expiresAt:"",bomid:"-MmdKHDHWZAwg3TZbKmL"},1:{type:"recipe",recipe:"Sweet & Salty",nut:"Almonds",startAt:"",endAt:"",expiresAt:"",bomid:""},2:{type:"recipe",recipe:"Sweet & Salty",nut:"Cashews",startAt:"",endAt:"",expiresAt:"",bomid:""},3:{type:"recipe",recipe:"Sweet & Salty",nut:"Hazelnuts",startAt:"",endAt:"",expiresAt:"",bomid:""},4:{type:"recipe",recipe:"Bourbon",nut:"Pecans",startAt:"",endAt:"",expiresAt:"",bomid:""},5:{type:"recipe",recipe:"Bourbon",nut:"Almonds",startAt:"",endAt:"",expiresAt:"",bomid:""},6:{type:"recipe",recipe:"Bourbon",nut:"Cashews",startAt:"",endAt:"",expiresAt:"",bomid:""},7:{type:"recipe",recipe:"Bourbon",nut:"Hazelnuts",startAt:"",endAt:"",expiresAt:"",bomid:""},8:{type:"oprtns",proces:"warming",startAt:"",endAt:""},9:{type:"oprtns",proces:"cleaning",startAt:"",endAt:""},10:{type:"oprtns",proces:"off",startAt:""},11:{type:"errors",proces:"burnt",startAt:""}}},{_loadFBObject:i,_loadProdReport:c,_getPowerTxKey:p,data:o.data,models:o.models,templates:o.templates,power:{togglePower:function(){console.log("toggling power"),o.data.power.isOn.$value=!o.data.power.isOn.$value;var e=d().format();o.data.power.txs[p()]={timestamp:e,source:o.data.power.source.$value,turningOn:o.data.power.isOn.$value},o.data.power.isOn.$save(),o.data.power.txs.$save(),n.$broadcast("powerTxsLoaded",o.data.power.txs)}},production:{journalBatchStart:function(r){const n="/BOMs/"+r.cooking.bomid,a={},o={id:firebase.database().ref().child("JournalEntries").push().key,startAt:r.cooking.startAt,endedAt:"",type:"cooking",recipe:r.cooking.recipe,nut:r.cooking.nut,engagmentId:r.engagmentId,channelId:r.channelId,channelName:r.channelName,yrwk:r.yrWk,teamMembrId:"",teamMemName:"",temperature:0,wind:"",powerSource:"",BoMId:r.cooking.bomid,isComplete:!1,txs:{}};return new Promise(function(e,t){s.read(n).then(function(n){Object.keys(n.resources).forEach(function(e){var t=firebase.database().ref().child("Transactions").push().key,e={journalEntryId:o.id,ledgerId:r.ledgersMap[e],createdAt:d().format(),updatedAt:"",createdBy:"",updatedBy:"",debit:n.resources[e].qty,credit:0,description:"",engagmentId:r.engagmentId,channelName:r.channelName,channelId:r.channelId};a["/Transactions/"+t]=e,o.txs[t]=t}),a["/JournalEntries/"+o.id]=o,console.log(a),s.update(a).then(function(){e(o.id)})})})},journalBatchEnd:function(){}}}}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","$rootScope","$q","moment","Firebase"];
...
function config(e,t){t.hashPrefix(""),e.when("/",{redirectTo:"/member"}).when("/login",{templateUrl:"assets/views/login-page.htm",controller:"loginController",controllerAs:"vm"}).when("/member",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var o=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid):n.path("/login"),o.resolve()}),o.promise}]}}).when("/member/:uid",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var o=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid):n.path("/login"),o.resolve()}),o.promise}]}}).when("/member/:uid/settings",{templateUrl:"assets/views/acct-settings-page.htm",controller:"acctSettingsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var o=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/settings"):n.path("/login"),o.resolve()}),o.promise}]}}).when("/member/:uid/txs_assignments",{templateUrl:"assets/views/txs-assigments-page.htm",controller:"txsAssigmentsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var o=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/txs_assignments"):n.path("/login"),o.resolve()}),o.promise}]}}).when("/member/:uid/activities",{templateUrl:"assets/views/activities-page.htm",controller:"activitiesController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var o=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/activities"):n.path("/login"),o.resolve()}),o.promise}]}}).when("/minishop/:engmntId/:channelId/",{templateUrl:"assets/views/minishop/mdashboard-page.htm",controller:"minishopDashController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/settings",{templateUrl:"assets/views/minishop/settings-page.htm",controller:"minishopStngsController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/production",{templateUrl:"assets/views/minishop/production-page.htm",controller:"minishopProductionController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/salesTxs",{templateUrl:"assets/views/minishop/sales-txs-page.htm",controller:"minishopSalesTxsController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/balanceSheet",{templateUrl:"assets/views/minishop/balancesheet-page.htm",controller:"minishopBalancesheetController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/power",{templateUrl:"assets/views/minishop/power-source-page.htm",controller:"minishopPowerSourceController",controllerAs:"vm"}).when("/admin/channels",{templateUrl:"assets/views/admin-channels-page.htm",controller:"adminChannelsController",controllerAs:"vm"}).when("/admin/channels/:channelId",{templateUrl:"assets/views/admin-select-channel-page.htm",controller:"adminSelectChannelController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,t,n){var o=t.defer();return e.get.channelEngagments(n.current.params.channelId).then(function(e){console.log("got this",e),o.resolve(e)}),o.promise}]}}).when("/admin/engagments/:engagmentId",{templateUrl:"assets/views/admin-select-engagment-page.htm",controller:"adminSelectEngagmentController",controllerAs:"vm"}).when("/admin/schedule/weekly",{templateUrl:"assets/views/admin-weekly-schedule-page.htm",controller:"adminWeeklyScheduleController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,t,n){console.log("routing: ",n.current.params.Wk);var o=t.defer();return e.get.weeklyEngagments(n.current.params.Wk).then(function(e){console.log("got this",e),o.resolve(e)}),o.promise}]}}).when("/admin/fundsAllocations/daily",{templateUrl:"assets/views/admin-funds-allocations-daily-page.htm",controller:"adminFundsAllocationsDailyController",controllerAs:"vm"}).when("/admin/accts",{title:"Admin: Accounts",templateUrl:"assets/views/admin/accts-manage-page.htm",controller:"adminAcctsManageController",controllerAs:"vm"}).when("/admin/BoM",{templateUrl:"assets/views/admin/bom-list-page.htm",controller:"adminBoMListController",controllerAs:"vm"}).when("/admin/BoM/:bomId",{templateUrl:"assets/views/admin/a-bom-page.htm",controller:"adminABoMController",controllerAs:"vm"}).when("/admin/operationRoles",{templateUrl:"assets/views/admin/opRoles-list-page.htm",controller:"adminOpRolesListContoller",controlerAs:"vm"}).when("/admin/ledgers",{title:"Admin: Ledgers",templateUrl:"assets/views/admin/ledgers-list-page.htm",controller:"adminLedgerslistController",controllerAs:"vm"}).otherwise({redirectTo:"/"})}config.$inject=["$routeProvider","$locationProvider"],angular.module("ckc").config(config);
function adminABoMController(o,r,e){const l=firebase.database();var n=l.ref("BOMs/"+r.bomId),r=l.ref("OpRoles");this.record=o(n),this.roleOptions=o(r),console.log("in a bill of materials controller ")}ckc.controller("adminABoMController",adminABoMController),adminABoMController.$inject=["$firebaseObject","$routeParams","$scope"];
...
function adminBoMListController(o,t){const e=firebase.database();var i=e.ref("BOMs");this.bomsList=o(i),console.log("in the bill of materials controller ")}ckc.controller("adminBoMListController",adminBoMListController),adminBoMListController.$inject=["$firebaseObject","$scope"];
function adminChannelsController(n,a,e){console.log("$routeParams",n);var l;this.channelsData=(l=firebase.database().ref("Channels"),a(l)),this.rowClicked=function(n){e.path("/admin/channels/"+n)},console.log("in the admin channels controller ")}ckc.controller("adminChannelsController",adminChannelsController),adminChannelsController.$inject=["$routeParams","$firebaseObject","$location"];
...
function adminLedgerslistController(e,t){var s=this;const r=firebase.database();var c=r.ref("Ledgers"),l=r.ref("Accts"),n=r.ref("SubAccts"),i=r.ref("Channels");s.ledgersList=e(c),s.acctsList=e(l),s.subAcctsList=e(n),s.channelsList=e(i),s.activeSelection={type:"",acct:"",sact:"",chnl:""},console.log("in the ledger list controller ")}ckc.controller("adminLedgerslistController",adminLedgerslistController),adminLedgerslistController.$inject=["$firebaseObject","$scope"];
function adminOpRolesListContoller(o,e){const l=firebase.database();var s=l.ref("OpRoles");this.opRolesList=o(s),console.log("in the op roles list controller ",this.opRolesList)}ckc.controller("adminOpRolesListContoller",adminOpRolesListContoller),adminOpRolesListContoller.$inject=["$firebaseObject","$scope"];
function adminSelectChannelController(n,e,a,l){console.log("$routeParams",n);var t,o=this;o.channelData=(t="Channels/"+(t=n.channelId),t=firebase.database().ref(t),e(t)),o.engagementsData=l,o.rowClick=function(n){console.log(n),a.path("/admin/engagments/"+n)},o.sumEngagments=function(n){var e=0;return Object.keys(n).forEach(function(n){e=n.length}),e},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location","engagemnts"];
function adminSelectEngagmentController(n,e,t){console.log("$routeParams",n);var a,o=this;o.engagmentData=(a="Engagments/"+(a=n.engagmentId),a=firebase.database().ref(a),e(a)),o.channelClicked=function(n){console.log(n),t.path("/admin/channels/"+n)},o.dateConcatenate=function(n,e){return n+"T"+e},o.yrWkDConcatenate=function(n,e,t){if(null!=n&&null!=e&&null!=t)return n.toString()+e.toString()+t.toString()},console.log("in the admin engagment channel controller ")}ckc.controller("adminSelectEngagmentController",adminSelectEngagmentController),adminSelectEngagmentController.$inject=["$routeParams","$firebaseObject","$location"];
...
function minishopProductionController(e,o,t,r,n,c,i){let p=this;p.params=o;function a(){if("Cooking"==p.prodReport.lastStatus){var o=i(p.prodReport.cooking.startAt);const t=i();p.batch.secElapsed=i.duration(t.diff(o)).as("seconds"),function(){var o=i(p.prodReport.cooking.startAt);const t=i();o=100*(i.duration(t.diff(o)).as("seconds")/1200).toFixed(2),p.batch.prcntPrgs=o}()}}p.recipes=function(t){const r={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(r[o]=t[o])}),r}(c.models.operations),p.batch={prcntPrgs:0,secElapsed:0},p.cookingList=[],c.data.production.report.$bindTo(r,"vm.prodReport").then(function(){p.cookingList=[],Object.keys(p.prodReport.journalEntries).forEach(function(o){if("_hold"!=o){o="/JournalEntries/"+p.prodReport.journalEntries[o];const t=firebase.database();o=t.ref(o);p.cookingList.push(e(o))}})}),p.selectRecipe=function(o){var t=null==p.prodReport.ondeck.recipe,r=p.prodReport.ondeck.recipe==p.recipes[o].recipe&&p.prodReport.ondeck.nut==p.recipes[o].nut;(!t||r)&&(t||r)?!t&&r&&(p.prodReport.ondeck={_hold:""}):p.prodReport.ondeck=p.recipes[o]},p.startNewBatch=function(){null!=p.prodReport.ondeck.recipe?(p.prodReport.cooling=p.prodReport.cooking,p.prodReport.cooling.endAt=i().format(),p.prodReport.cooking=p.prodReport.ondeck,p.prodReport.lastStatus="Cooking",p.prodReport.cooking.startAt=i().format(),p.prodReport.cooking.expiresAt=i(p.prodReport.cooking.startAt).add(20,"minutes").format(),p.batch.secElapsed=0,c.production.journalBatchStart(p.prodReport).then(function(o){var t="JournalEntries/"+o;console.log("readPath",t);const r=firebase.database();t=r.ref(t),t=e(t);p.cookingList.push(t),p.prodReport.journalEntries[i().format()]=o}),p.prodReport.ondeck={_hold:""}):console.log("need to select a batch first")},p.calculateCookingDone=function(o){if(""==o)return"";{const t=i(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},p.calculateCookingError=function(o){},p.validatePercentProgress=function(o){return null==o||NaN==o?0:o},console.log("in the miniship production controller "),t(function(){a()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$firebaseObject","$routeParams","$interval","$scope","$window","msData","moment"];
