...
function Firebase(){return this.data=["one","two"],console.log("Firebase Service"),{read:function(e){const r=firebase.database().ref(e);return new Promise(function(a,e){r.on("value",function(e){e=e.val();a(e)})})},query:{child:function(e,a,r){const n=firebase.database().ref(e);n.orderByChild(a).equalTo(r)}}}}ckc.factory("Firebase",Firebase),Firebase.$inject=[];
...
function msData(e,c,t,a,d,n,l){var i=this;function r(e){e=firebase.database().ref(e);return c(e)}return i.templates={prodReport:{ondeck:{_hold:""},cooking:{_hold:""},cooling:{_hold:""},engagmentId:"",channelName:"",channelId:"",yrWk:0,status:"",journalEntries:{_hold:""},acctsMap:{_hold:""}}},i.data={power:{isOn:r("Engagments/"+t.engmntId+"/power/isOn"),source:r("Engagments/"+t.engmntId+"/power/source"),txs:r("Engagments/"+t.engmntId+"/power/txs")},production:{report:function(e,t){console.log("self.templates",i.templates);const a=d.defer(),n=firebase.database(),r=n.ref("ProductionReports/"+e),o=c(r),s=l.read("Channels/"+t),p=i.templates.prodReport;p.engagmentId=e,Promise.all([o,s]).then(function(e){e=e[1];return null==o.$value?(o.$value=p,o.$value.channelName=e.name,o.$value.channelId=t,o.$value.acctsMap=e.acctsMap,o.$save().then(function(){console.log("production report saved",o),a.resolve(o)}),a.promise):(console.log("found a record",result),o)})}(t.engmntId,t.channelId)}},i.models={operations:{0:{type:"recipe",recipe:"Sweet & Salty",nut:"Pecans",startAt:"",endAt:""},1:{type:"recipe",recipe:"Sweet & Salty",nut:"Almonds",startAt:"",endAt:""},2:{type:"recipe",recipe:"Sweet & Salty",nut:"Cashews",startAt:"",endAt:""},3:{type:"recipe",recipe:"Sweet & Salty",nut:"Hazelnuts",startAt:"",endAt:""},4:{type:"recipe",recipe:"Bourbon",nut:"Pecans",startAt:"",endAt:""},5:{type:"recipe",recipe:"Bourbon",nut:"Almonds",startAt:"",endAt:""},6:{type:"recipe",recipe:"Bourbon",nut:"Cashews",startAt:"",endAt:""},7:{type:"recipe",recipe:"Bourbon",nut:"Hazelnuts",startAt:"",endAt:""},8:{type:"oprtns",proces:"warming",startAt:"",endAt:""},9:{type:"oprtns",proces:"cleaning",startAt:"",endAt:""},10:{type:"oprtns",proces:"off",startAt:"",endAt:""},11:{type:"errors",proces:"burnt",startAt:"",endAt:""}}},{data:i.data,models:i.models,templates:i.templates,power:{togglePower:function(){console.log("toggling power"),i.data.power.isOn.$value=!i.data.power.isOn.$value;var e=n().format();i.data.power.txs[n().format("x")]={timestamp:e,source:i.data.power.source.$value,turningOn:i.data.power.isOn.$value},i.data.power.isOn.$save(),i.data.power.txs.$save(),a.$broadcast("powerTxsLoaded",i.data.power.txs)}}}}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","$rootScope","$q","moment","Firebase"];
...
function minishopProductionController(o,t,e,n,c,i){let r=this;function s(){"Cooking"==r.cookingMetrics.status&&(r.cookingMetrics.timeElapsed++,function(){var o=i(r.cookingMetrics.startngTime);const t=i();o=100*(i.duration(t.diff(o)).as("seconds")/1200).toFixed(2),r.cookingMetrics.prcntPrgs=o}())}r.recipes=function(t){const e={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(e[o]=t[o])}),e}(c.models.operations),r.prodReport=c.data.production.report,r.batches={ondeck:{},cooking:{},cooling:{}},r.cookingMetrics={startngTime:"",expiresAt:"",timeElapsed:0,status:"Off",prcntPrgs:0},r.selectRecipe=function(o){var t=null==r.batches.ondeck.recipe,e=r.batches.ondeck.recipe==r.recipes[o].recipe&&r.batches.ondeck.nut==r.recipes[o].nut;(!t||e)&&(t||e)?!t&&e&&(r.batches.ondeck={}):r.batches.ondeck=r.recipes[o]},r.startNewBatch=function(){null!=r.batches.ondeck.recipe?(console.log("starting a new batch"),r.batches.cooling=r.batches.cooking,r.batches.cooking=r.batches.ondeck,r.cookingMetrics.status="Cooking",r.cookingMetrics.startngTime=i().format(),r.cookingMetrics.timeElapsed=0,r.batches.ondeck={}):console.log("ned to select a batch first")},r.calculateCookingDone=function(o){if(""==o)return"";{const t=i(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},r.calculateCookingError=function(o){},console.log("in the miniship production controller "),t(function(){s()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$routeParams","$interval","$scope","$window","msData","moment"];
