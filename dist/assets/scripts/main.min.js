...
function engagmentProjetionsController(e){this.routeParams=e,this.user=firebase.auth().currentUser,console.log("in the engagment projections  controller ")}ckc.controller("engagmentProjetionsController",engagmentProjetionsController),engagmentProjetionsController.$inject=["$routeParams"];