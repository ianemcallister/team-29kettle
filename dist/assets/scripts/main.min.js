...
function minishopPowerSourceController(o,n,e,s,u){var a=this;function p(o,n){let e=!1;const s=[""];return n.forEach(function(o){s.push(o)}),s.push(""),"object"==typeof s[o]&&"on"==s[o].turning&&(e=!0),e}function t(){var o=u(new Date).hour(0).minute(0).second(0).format(),n=u(new Date).format(),e=[],s=[];a.opSeconds.generator.total=0,a.opSeconds.generator.continous=0,a.opSeconds.house.total=0,a.opSeconds.house.continous=0,e.push(o),a.txs.forEach(function(o){e.push(u(o.timestamp))}),e.push(n);for(let o=0;o<e.length-1;o++){var t=new u(e[o]);const r=new u(e[o+1]),c=u.duration(r.diff(t)),i={prcntg:100*(c.as("seconds")/86399).toFixed(2),seconds:c.as("seconds"),isOn:p(o,a.txs),classes:["progress-bar"]};i.isOn&&i.classes.push("bg-warning"),p(o,a.txs)&&(a.opSeconds.house.total+=c.as("seconds"),a.opSeconds.house.continous=c.as("seconds")),s.push(i)}return s}e.Math=window.Math,a.params=o,a.powerIsOn=!1,a.powerSource="generator",a.txs=[],a.opSeconds={generator:{continous:0,total:0},house:{continous:0,total:0}},a.timeBlocks=t(),a.toggleOnOff=function(){var o="off";a.powerIsOn||(o="on"),a.txs.push({timestamp:u(new Date).format(),source:a.powerSource,turning:o}),a.timeBlocks=t(),a.powerIsOn=!a.powerIsOn},console.log("in the power source controller "),n(function(){a.timeBlocks=t()},1e4)}ckc.controller("minishopPowerSourceController",minishopPowerSourceController),minishopPowerSourceController.$inject=["$routeParams","$interval","$scope","MiniShop","moment"];
