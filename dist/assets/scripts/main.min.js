...
function msData(e,a,t,r,n,s,p){var o=this;function c(e){e=firebase.database().ref(e);return a(e)}return o.templates={prodReport:{ondeck:{_hold:""},cooking:{_hold:""},cooling:{_hold:""},engagmentId:"",channelName:"",channelId:"",yrWk:0,status:"",journalEntries:{_hold:""},acctsMap:{_hold:""},lastStatus:"Off"}},o.data={power:{isOn:c("Engagments/"+t.engmntId+"/power/isOn"),source:c("Engagments/"+t.engmntId+"/power/source"),txs:c("Engagments/"+t.engmntId+"/power/txs")},production:{report:function(e){n.defer();const t=firebase.database(),r=t.ref("ProductionReports/"+e),s=a(r);return s}(t.engmntId,t.channelId)}},o.models={operations:{0:{type:"recipe",recipe:"Sweet & Salty",nut:"Pecans",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},1:{type:"recipe",recipe:"Sweet & Salty",nut:"Almonds",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},2:{type:"recipe",recipe:"Sweet & Salty",nut:"Cashews",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},3:{type:"recipe",recipe:"Sweet & Salty",nut:"Hazelnuts",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},4:{type:"recipe",recipe:"Bourbon",nut:"Pecans",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},5:{type:"recipe",recipe:"Bourbon",nut:"Almonds",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},6:{type:"recipe",recipe:"Bourbon",nut:"Cashews",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},7:{type:"recipe",recipe:"Bourbon",nut:"Hazelnuts",startAt:"",endAt:"",expiresAt:"",secElapsed:0,prcntPrgs:0},8:{type:"oprtns",proces:"warming",startAt:"",endAt:""},9:{type:"oprtns",proces:"cleaning",startAt:"",endAt:""},10:{type:"oprtns",proces:"off",startAt:""},11:{type:"errors",proces:"burnt",startAt:""}}},{data:o.data,models:o.models,templates:o.templates,power:{togglePower:function(){console.log("toggling power"),o.data.power.isOn.$value=!o.data.power.isOn.$value;var e=s().format();o.data.power.txs[s().format("x")]={timestamp:e,source:o.data.power.source.$value,turningOn:o.data.power.isOn.$value},o.data.power.isOn.$save(),o.data.power.txs.$save(),r.$broadcast("powerTxsLoaded",o.data.power.txs)}}}}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","$rootScope","$q","moment","Firebase"];
...
function minishopProductionController(o,t,r,e,n,c){let i=this;i.params=o;function p(){"Cooking"==i.prodReport.lastStatus&&(i.prodReport.cooking.secElapsed++,function(){var o=c(i.prodReport.cooking.startAt);const t=c();o=100*(c.duration(t.diff(o)).as("seconds")/1200).toFixed(2),i.prodReport.cooking.prcntPrgs=o}())}i.recipes=function(t){const r={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(r[o]=t[o])}),r}(n.models.operations),n.data.production.report.$bindTo(r,"vm.prodReport").then(function(){}),i.selectRecipe=function(o){var t=null==i.prodReport.ondeck.recipe,r=i.prodReport.ondeck.recipe==i.recipes[o].recipe&&i.prodReport.ondeck.nut==i.recipes[o].nut;(!t||r)&&(t||r)?!t&&r&&(i.prodReport.ondeck={_hold:""}):i.prodReport.ondeck=i.recipes[o]},i.startNewBatch=function(){null!=i.prodReport.ondeck.recipe?(console.log("starting a new batch"),i.prodReport.cooling=i.prodReport.cooking,i.prodReport.cooking=i.prodReport.ondeck,i.prodReport.lastStatus="Cooking",i.prodReport.cooking.startAt=c().format(),i.prodReport.cooking.secElapsed=0,i.prodReport.ondeck={_hold:""}):console.log("ned to select a batch first")},i.calculateCookingDone=function(o){if(""==o)return"";{const t=c(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},i.calculateCookingError=function(o){},i.validatePercentProgress=function(o){return null==o||NaN==o?0:o},console.log("in the miniship production controller "),t(function(){p()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$routeParams","$interval","$scope","$window","msData","moment"];
