...
function msData(e,n,t,r,s,a,o){var p=this;function i(e){e=firebase.database().ref(e);return n(e)}return p.templates={prodReport:{ondeck:{_hold:""},cooking:{_hold:""},cooling:{_hold:""},engagmentId:"",channelName:"",channelId:"",yrWk:0,status:"",journalEntries:{_hold:""},acctsMap:{_hold:""},lastStatus:"Off"}},p.data={power:{isOn:i("Engagments/"+t.engmntId+"/power/isOn"),source:i("Engagments/"+t.engmntId+"/power/source"),txs:i("Engagments/"+t.engmntId+"/power/txs")},production:{report:function(e){s.defer();const t=firebase.database(),r=t.ref("ProductionReports/"+e),a=n(r);return a}(t.engmntId,t.channelId)}},p.models={operations:{0:{type:"recipe",recipe:"Sweet & Salty",nut:"Pecans",startAt:"",endAt:"",expiresAt:""},1:{type:"recipe",recipe:"Sweet & Salty",nut:"Almonds",startAt:"",endAt:"",expiresAt:""},2:{type:"recipe",recipe:"Sweet & Salty",nut:"Cashews",startAt:"",endAt:"",expiresAt:""},3:{type:"recipe",recipe:"Sweet & Salty",nut:"Hazelnuts",startAt:"",endAt:"",expiresAt:""},4:{type:"recipe",recipe:"Bourbon",nut:"Pecans",startAt:"",endAt:"",expiresAt:""},5:{type:"recipe",recipe:"Bourbon",nut:"Almonds",startAt:"",endAt:"",expiresAt:""},6:{type:"recipe",recipe:"Bourbon",nut:"Cashews",startAt:"",endAt:"",expiresAt:""},7:{type:"recipe",recipe:"Bourbon",nut:"Hazelnuts",startAt:"",endAt:"",expiresAt:""},8:{type:"oprtns",proces:"warming",startAt:"",endAt:""},9:{type:"oprtns",proces:"cleaning",startAt:"",endAt:""},10:{type:"oprtns",proces:"off",startAt:""},11:{type:"errors",proces:"burnt",startAt:""}}},{data:p.data,models:p.models,templates:p.templates,power:{togglePower:function(){console.log("toggling power"),p.data.power.isOn.$value=!p.data.power.isOn.$value;var e=a().format();p.data.power.txs[a().format("x")]={timestamp:e,source:p.data.power.source.$value,turningOn:p.data.power.isOn.$value},p.data.power.isOn.$save(),p.data.power.txs.$save(),r.$broadcast("powerTxsLoaded",p.data.power.txs)}}}}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","$rootScope","$q","moment","Firebase"];
