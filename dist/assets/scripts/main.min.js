...
function minishopProductionController(n,o,t,r,e,i,s){let p=this;p.params=o;function a(){if("Cooking"==p.prodReport.lastStatus){var o=s(p.prodReport.cooking.startAt);const t=s();p.batch.secElapsed=s.duration(t.diff(o)).as("seconds"),function(){var o=s(p.prodReport.cooking.startAt);const t=s();o=100*(s.duration(t.diff(o)).as("seconds")/1200).toFixed(2),p.batch.prcntPrgs=o}()}}p.recipes=function(t){const r={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(r[o]=t[o])}),r}(i.models.operations),p.cookingList=[],p.txsList=[],p.batch={prcntPrgs:0,secElapsed:0},p.txsSummary={debits:{"-MmdFOUdWJKSaiY8qSBP":0,"-Mnwy1lULD6uf9qPLb7w":0,"-Mnwy9s4CdquFHL4EBpJ":0,"-MnwyPKyV9j1riq3z_Jv":0,"-Mo9ypVIJTf09YLBRGTd":0,"-Mo9yxhpuLbnJLqsjZfo":0,"-Mo9zUaMv11hJrJ4tref":0,"-Mo9zW4ShhozB04JDoh8":0,"-Mo9zXdi2ZCUqPG6iTh-":0,"-Mo9zYz8loLwGvu8fGB2":0,"-MjSoxKn1xrLk8L1b8PK":0,"-Mnv9B2Eip7PPZaN7aYa":0,"-Mo9zo0gB2vNAwGThDbe":0,"-Mo9zsxpeHi8estWW0bG":0},credits:{},balances:{"-MjSoxLGadkQpxtTuhCK":0,"-MnwvGpt6TTehfomFo18":0,"-MnwvK9M4P5v_9w_2cSa":0,"-MnwvNdZ2xqY2_8u9Ub7":0,"-MnvHa-65LfIp63akaI-":0,"-MnwvSTpy0dJAU5S_vgi":0,"-MnwvTh3Ax5g7KuZL8SB":0,"-MnwvXyu20U9VpKhWoJB":0,"-MjSoxKn1xrLk8L1b8PK":0,"-Mnv9B2Eip7PPZaN7aYa":0}},i.data.production.report.$bindTo(r,"vm.prodReport").then(function(){!function(){p.cookingList=[],null!=p.prodReport.journalEntries&&null!=p.prodReport.journalEntries||(p.prodReport.journalEntries={});Object.keys(p.prodReport.journalEntries).forEach(function(o){if("_hold"!=o){o="/JournalEntries/"+p.prodReport.journalEntries[o];const t=firebase.database();o=t.ref(o);p.cookingList.push(n(o))}})}(),function(){p.txsList=[],null!=p.prodReport.txs&&null!=p.prodReport.txs||(p.prodReport.txs={});Object.keys(p.prodReport.txs).forEach(function(o){if("_hold"!=o){o="Transactions/"+o;const t=firebase.database();o=t.ref(o);p.txsList.push(n(o))}})}()}),p.selectRecipe=function(o){var t=null==p.prodReport.ondeck.recipe,r=p.prodReport.ondeck.recipe==p.recipes[o].recipe&&p.prodReport.ondeck.nut==p.recipes[o].nut;(!t||r)&&(t||r)?!t&&r&&(p.prodReport.ondeck={_hold:""}):p.prodReport.ondeck=p.recipes[o]},p.startNewBatch=function(){null!=p.prodReport.ondeck.recipe?(p.prodReport.cooling=p.prodReport.cooking,p.prodReport.cooling.endAt=s().format(),p.prodReport.cooking=p.prodReport.ondeck,p.prodReport.lastStatus="Cooking",p.prodReport.cooking.startAt=s().format(),p.prodReport.cooking.expiresAt=s(p.prodReport.cooking.startAt).add(20,"minutes").format(),p.batch.secElapsed=0,i.production.journalBatchStart(p.prodReport).then(function(o){var t="JournalEntries/"+o.jeId;const r=firebase.database();t=r.ref(t),t=n(t);p.cookingList.push(t),p.prodReport.journalEntries[s().format()]=o.jeId,o.txIds.forEach(function(o){var t="Transactions/"+o;const r=firebase.database();t=r.ref(t),t=n(t);p.txsList.push(t),null!=p.prodReport.txs&&null!=p.prodReport.txs||(p.prodReport.txs={}),p.prodReport.txs[o]=o})}),p.prodReport.ondeck={_hold:""}):console.log("need to select a batch first")},p.calculateCookingDone=function(o){if(""==o)return"";{const t=s(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},p.calculateCookingError=function(o){},p.validatePercentProgress=function(o){return null==o||NaN==o?0:o},console.log("in the miniship production controller "),t(function(){a()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$firebaseObject","$routeParams","$interval","$scope","$window","msData","moment"];
