...
function dailyFundsCollected(){l.$inject=["scope","el","attr","ctrl"];var t={restrict:"AECM",templateUrl:"assets/views/directives/daily-funds-collected.htm",replace:!0,scope:{date:"="},link:l,controller:e,controllerAs:"vm",bindToController:!0};function l(e,t,l,o){e.$watch("date",function(t,l){e.vm.loadPayments(e.vm.date)})}function e(l,t,e){console.log("in the daily funds collected directive");this.paymentsCollected="",l.vm.loadPayments=function(t){e.get.dailyCollections(t).then(function(t){var e,o;console.log(t),l.vm.paymentsCollected=t,l.vm.collectionsByTeamMember=(e=t,o={},Object.keys(e).forEach(function(t){var l=e[t].employeeId;null==l?(null==o.UNKNOWN&&(o.UNKNOWN={totalCollections:0,totalFundsCollected:0,totalSalesCollected:0,firstCollection:"",lastCollection:"",txs:{}}),o.UNKNOWN.txs[t]=e[t],o.UNKNOWN.totalCollections++,o.UNKNOWN.totalFundsCollected+=e[t].totalMoney.amount,o.UNKNOWN.totalSalesCollected+=e[t].amountMoney.amount,null!=e[t].tipMoney&&(o.UNKNOWN.totalTipsCollected+=e[t].tipMoney.amount)):(null==o[l]&&(o[l]={totalCollections:0,totalFundsCollected:0,totalSalesCollected:0,totalTipsCollected:0,firstCollection:"",lastCollection:"",txs:{}}),o[l].txs[t]=e[t],o[l].totalCollections++,o[l].totalFundsCollected+=e[t].totalMoney.amount,o[l].totalSalesCollected+=e[t].amountMoney.amount,null!=e[t].tipMoney&&(o[l].totalTipsCollected+=e[t].tipMoney.amount))}),o)}).catch(function(t){console.log("error: ",t)})}}return e.$inject=["$scope","$log","Database"],t}ckc.directive("dailyFundsCollected",dailyFundsCollected);
...
function adminFundsAllocationsDailyController(n,l,o,t){var a=this;a.currentDate="",a.engagments="",a.formatTime=function(n){n=a.currentDate+"T"+n;return t(n).format("h:mm a")},null!=n.date&&(a.currentDate=n.date),null!=o&&(a.engagments=o),Object.keys(n)<1&&(n="admin/fundsAllocations/daily?date="+t().format("YYYY-MM-DD"),console.log(n),l.url(n)),console.log("in the adminFundsAllocationsDailyController ")}ckc.controller("adminFundsAllocationsDailyController",adminFundsAllocationsDailyController),adminFundsAllocationsDailyController.$inject=["$routeParams","$location","engagements","moment"];
