...
function adminSelectChannelController(e,n,l,a){console.log("$routeParams",e);var t=this;const o=firebase.database();e=o.ref("Channels/"+e.channelId);t.channelData=n(e),t.engagementsData=a,t.newRLSelections={roleid:"",ledgerId:""},t.rowClick=function(e){console.log(e),l.path("/admin/engagments/"+e)},t.sumEngagments=function(e){var n=0;return Object.keys(e).forEach(function(e){n=e.length}),n},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location","engagemnts"];
...
function minishopProductionController(r,o,t,e,n,i,a){let s=this;s.params=o;function c(n){Object.keys(s.txsSummary).forEach(function(r){const o=s.txsSummary[r];Object.keys(o).forEach(function(t){const e=o[t];Object.keys(e).forEach(function(o){e[o].id==n.roleId&&(s.txsSummary[r][t][o].value+=n.credit,s.txsSummary[r][t][o].value-=n.debit)})})})}function p(){if("Cooking"==s.prodReport.lastStatus){var o=a(s.prodReport.cooking.startAt);const t=a();s.batch.secElapsed=a.duration(t.diff(o)).as("seconds"),function(){var o=a(s.prodReport.cooking.startAt);const t=a();o=100*(a.duration(t.diff(o)).as("seconds")/1200).toFixed(2),s.batch.prcntPrgs=o}()}}s.recipes=function(t){const e={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(e[o]=t[o])}),e}(i.models.operations),s.cookingList=[],s.txsList=[],s.batch={prcntPrgs:0,secElapsed:0},s.txsSummary={debits:{nuts:{pecans:{id:"-MmdFOUdWJKSaiY8qSBP",value:0},almonds:{id:"-Mnwy1lULD6uf9qPLb7w",value:0},cashews:{id:"-Mnwy9s4CdquFHL4EBpJ",value:0},hazelnuts:{id:"-MnwyPKyV9j1riq3z_Jv",value:0}},packaging:{pintcups:{id:"-Mo9ypVIJTf09YLBRGTd",value:0},pintLids:{id:"-Mo9yxhpuLbnJLqsjZfo",value:0},halfCups:{id:"-Mo9zUaMv11hJrJ4tref",value:0},halfLids:{id:"-Mo9zW4ShhozB04JDoh8",value:0},platTops:{id:"-Mo9zXdi2ZCUqPG6iTh-",value:0},platBots:{id:"-Mo9zYz8loLwGvu8fGB2",value:0}},cooking:{ssMix:{id:"-MjSoxKn1xrLk8L1b8PK",value:0},bbMix:{id:"-Mnv9B2Eip7PPZaN7aYa",value:0},salt:{id:"-MjSoxKn1xrLk8L1b8PK",value:0}},misc:{paperTowel:{id:"-Mo9zsxpeHi8estWW0bG",value:0},gasoline:{id:"-Mo9zo0gB2vNAwGThDbe",value:0}}},credits:{},balances:{"-MjSoxLGadkQpxtTuhCK":0,"-MnwvGpt6TTehfomFo18":0,"-MnwvK9M4P5v_9w_2cSa":22,"-MnwvNdZ2xqY2_8u9Ub7":0,"-MnvHa-65LfIp63akaI-":0,"-MnwvSTpy0dJAU5S_vgi":0,"-MnwvTh3Ax5g7KuZL8SB":0,"-MnwvXyu20U9VpKhWoJB":0,"-MjSoxKn1xrLk8L1b8PK":0,"-Mnv9B2Eip7PPZaN7aYa":0}},i.data.production.report.$bindTo(e,"vm.prodReport").then(function(){!function(){s.cookingList=[],null!=s.prodReport.journalEntries&&null!=s.prodReport.journalEntries||(s.prodReport.journalEntries={});Object.keys(s.prodReport.journalEntries).forEach(function(o){if("_hold"!=o){o="/JournalEntries/"+s.prodReport.journalEntries[o];const t=firebase.database();o=t.ref(o);s.cookingList.push(r(o))}})}(),function(){s.txsList=[],null!=s.prodReport.txs&&null!=s.prodReport.txs||(s.prodReport.txs={});Object.keys(s.prodReport.txs).forEach(function(o){if("_hold"!=o){o="Transactions/"+o;const t=firebase.database();o=t.ref(o),o=r(o).$loaded().then(function(o){c(o)});s.txsList.push(o)}})}()}),s.selectRecipe=function(o){var t=null==s.prodReport.ondeck.recipe,e=s.prodReport.ondeck.recipe==s.recipes[o].recipe&&s.prodReport.ondeck.nut==s.recipes[o].nut;(!t||e)&&(t||e)?!t&&e&&(s.prodReport.ondeck={_hold:""}):s.prodReport.ondeck=s.recipes[o]},s.startNewBatch=function(){null!=s.prodReport.ondeck.recipe?(s.prodReport.cooling=s.prodReport.cooking,s.prodReport.cooling.endAt=a().format(),s.prodReport.cooking=s.prodReport.ondeck,s.prodReport.lastStatus="Cooking",s.prodReport.cooking.startAt=a().format(),s.prodReport.cooking.expiresAt=a(s.prodReport.cooking.startAt).add(20,"minutes").format(),s.batch.secElapsed=0,i.production.journalBatchStart(s.prodReport).then(function(o){var t="JournalEntries/"+o.jeId;const e=firebase.database();t=e.ref(t),t=r(t);s.cookingList.push(t),s.prodReport.journalEntries[a().format()]=o.jeId,o.txIds.forEach(function(o){var t="Transactions/"+o;const e=firebase.database();t=e.ref(t),t=r(t).$loaded().then(function(o){c(o)});s.txsList.push(t),null!=s.prodReport.txs&&null!=s.prodReport.txs||(s.prodReport.txs={}),s.prodReport.txs[o]=o})}),s.prodReport.ondeck={_hold:""}):console.log("need to select a batch first")},s.calculateCookingDone=function(o){if(""==o)return"";{const t=a(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},s.calculateCookingError=function(o){},s.validatePercentProgress=function(o){return null==o||NaN==o?0:o},console.log("in the miniship production controller "),t(function(){p()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$firebaseObject","$routeParams","$interval","$scope","$window","msData","moment"];
