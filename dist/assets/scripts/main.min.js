...
function minishopProductionController(r,o,t,e,n,a,i,s){let d=this;d.params=o;function p(n){Object.keys(d.txsSummary).forEach(function(r){const o=d.txsSummary[r];Object.keys(o).forEach(function(t){const e=o[t];Object.keys(e).forEach(function(o){e[o].id==n.roleId&&(d.txsSummary[r][t][o].value+=n.credit,d.txsSummary[r][t][o].value-=n.debit)})})})}function c(){if("Cooking"==d.prodReport.lastStatus){var o=i(d.prodReport.cooking.startAt);const t=i();d.batch.secElapsed=i.duration(t.diff(o)).as("seconds"),function(){var o=i(d.prodReport.cooking.startAt);const t=i();o=100*(i.duration(t.diff(o)).as("seconds")/1200).toFixed(2),d.batch.prcntPrgs=o}()}}d.user=firebase.auth().currentUser,d.channel=r(firebase.database().ref("Channels/"+o.channelId)),d.engagment=r(firebase.database().ref("Engagments/"+o.engmntId)),d.recipes=function(t){const e={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(e[o]=t[o])}),e}(a.models.operations),d.cookingList=[],d.txsList=[],d.conditions={temperature:66,wind:{speed:0,deg:0},roaster:""},d.batch={prcntPrgs:0,secElapsed:0},d.roasters=["214606","213588","21353x","216693"],d.txsSummary={debits:{nuts:{pecans:{id:"-MmdFOUdWJKSaiY8qSBP",value:0},almonds:{id:"-Mnwy1lULD6uf9qPLb7w",value:0},cashews:{id:"-Mnwy9s4CdquFHL4EBpJ",value:0},hazelnuts:{id:"-MnwyPKyV9j1riq3z_Jv",value:0}},packaging:{pintcups:{id:"-Mo9ypVIJTf09YLBRGTd",value:0},pintLids:{id:"-Mo9yxhpuLbnJLqsjZfo",value:0},halfCups:{id:"-Mo9zUaMv11hJrJ4tref",value:0},halfLids:{id:"-Mo9zW4ShhozB04JDoh8",value:0},platTops:{id:"-Mo9zXdi2ZCUqPG6iTh-",value:0},platBots:{id:"-Mo9zYz8loLwGvu8fGB2",value:0}},cooking:{ssMix:{id:"-MjSoxKn1xrLk8L1b8PK",value:0},bbMix:{id:"-Mnv9B2Eip7PPZaN7aYa",value:0},salt:{id:"-MjSoxKn1xrLk8L1b8PK",value:0}},misc:{paperTowel:{id:"-Mo9zsxpeHi8estWW0bG",value:0},gasoline:{id:"-Mo9zo0gB2vNAwGThDbe",value:0}}},credits:{},balances:{"-MjSoxLGadkQpxtTuhCK":0,"-MnwvGpt6TTehfomFo18":0,"-MnwvK9M4P5v_9w_2cSa":22,"-MnwvNdZ2xqY2_8u9Ub7":0,"-MnvHa-65LfIp63akaI-":0,"-MnwvSTpy0dJAU5S_vgi":0,"-MnwvTh3Ax5g7KuZL8SB":0,"-MnwvXyu20U9VpKhWoJB":0,"-MjSoxKn1xrLk8L1b8PK":0,"-Mnv9B2Eip7PPZaN7aYa":0}},a.data.production.report.$bindTo(e,"vm.prodReport").then(function(){!function(){d.cookingList=[],null!=d.prodReport.journalEntries&&null!=d.prodReport.journalEntries||(d.prodReport.journalEntries={});Object.keys(d.prodReport.journalEntries).forEach(function(o){if("_hold"!=o){o="/JournalEntries/"+d.prodReport.journalEntries[o];const t=firebase.database();o=t.ref(o);d.cookingList.push(r(o))}})}(),function(){d.txsList=[],null!=d.prodReport.txs&&null!=d.prodReport.txs||(d.prodReport.txs={});Object.keys(d.prodReport.txs).forEach(function(o){if("_hold"!=o){o="Transactions/"+o;const t=firebase.database();o=t.ref(o),o=r(o).$loaded().then(function(o){p(o)});d.txsList.push(o)}})}()}),d.selectRecipe=function(o){var t=null==d.prodReport.ondeck.recipe,e=d.prodReport.ondeck.recipe==d.recipes[o].recipe&&d.prodReport.ondeck.nut==d.recipes[o].nut;(!t||e)&&(t||e)?!t&&e&&(d.prodReport.ondeck={_hold:""}):d.prodReport.ondeck=d.recipes[o]},d.startNewBatch=function(){null!=d.prodReport.ondeck.recipe?(d.prodReport.cooling=d.prodReport.cooking,d.prodReport.cooling.endAt=i().format(),d.prodReport.cooking=d.prodReport.ondeck,d.prodReport.lastStatus="Cooking",d.prodReport.cooking.startAt=i().format(),d.prodReport.cooking.expiresAt=i(d.prodReport.cooking.startAt).add(20,"minutes").format(),d.prodReport.memberId="L1kSg6D6EIZP2ctV7bI0kEkZRAm2",d.prodReport.temp=d.conditions.temperature,d.prodReport.roasterId=d.conditions.roaster,d.batch.secElapsed=0,a.production.journalBatchStart(d.prodReport).then(function(o){var t="JournalEntries/"+o.jeId;const e=firebase.database();t=e.ref(t),t=r(t);d.cookingList.push(t),d.prodReport.journalEntries[i().format()]=o.jeId,o.txIds.forEach(function(o){var t="Transactions/"+o;const e=firebase.database();t=e.ref(t),t=r(t).$loaded().then(function(o){p(o)});d.txsList.push(t),null!=d.prodReport.txs&&null!=d.prodReport.txs||(d.prodReport.txs={}),d.prodReport.txs[o]=o})}),d.prodReport.ondeck={_hold:""}):console.log("need to select a batch first")},d.calculateCookingDone=function(o){if(""==o)return"";{const t=i(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},d.calculateCookingError=function(o){},d.validatePercentProgress=function(o){return null==o||NaN==o?0:o},d.dateEnding=function(o){},console.log("in the miniship production controller "),t(function(){c()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$firebaseObject","$routeParams","$interval","$scope","$window","msData","moment","$http"];
