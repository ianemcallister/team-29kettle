...
function adminABoMController(e,o,r){const c=this,s=firebase.database();var a=s.ref("BOMs/"+o.bomId),o=s.ref("OpRoles");c.record=e(a),c.roleOptions=e(o),c.aNewResource={id:"",qty:""},c.aNewSuccess={id:"",qty:""},c.aNewFailure={id:"",qty:""},c.addBtn=function(e,o){console.log("adding a new",e,o),""==c.record[e]&&(c.record[e]={}),c.record[e][o.id]=parseInt(o.qty),c.record.$save().then(function(){switch(console.log("new values saved successfully"),e){case"resource":c.aNewResource={id:"",qty:""};break;case"success":c.aNewSuccess={id:"",qty:""};break;case"failure":c.aNewFailure={id:"",qty:""}}})},c.removeButton=function(e,o){console.log("removing",e,o),c.record[e][o]=null,c.record.$save().then(function(){console.log("removal saved successfully")})},console.log("in a bill of materials controller ")}ckc.controller("adminABoMController",adminABoMController),adminABoMController.$inject=["$firebaseObject","$routeParams","$scope"];
