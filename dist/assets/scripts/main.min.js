...
function data(r){return{loadFBObject:function(e,n,t){console.log("loading firebase object",e,n,t);let c=firebase.database().ref(e),l="";return new Promise(function(o,e){var a;l=null!=n&&null!=t?(a=c.orderByChild(n).equalTo(t),r(a)):r(c),l.$loaded().then(function(e){console.log("success",e),o(l)}).catch(function(e){console.log("Error",e)})})}}}ckc.factory("data",data),data.$inject=["$firebaseObject"];
...
function engagmentProjetionsController(e,n,t,o){console.log("in the engagment projections  controller ",e);var r=this;o.loadFBObject("Engagments/"+e.engagmentId).then(function(e){e.$bindTo(t,"vm.engagment")}).catch(function(e){console.log("engagments error",e)}),r.user=firebase.auth().currentUser,r.routeParams=e,r.data={revType:"",revValue:0},r.updateRev=function(e){console.log("changing type",e)},r.weekNum=function(e,n,t){console.log("calculating weeknum",e,n,t);let o="";return null!=e&&null!=n&&null!=t&&(o=n.toString()+e.toString().padStart(2,"0")+t.toString()),o}}ckc.controller("engagmentProjetionsController",engagmentProjetionsController),engagmentProjetionsController.$inject=["$routeParams","$firebaseObject","$scope","data"];