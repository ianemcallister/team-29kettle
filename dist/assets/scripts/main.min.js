...
function adminSelectChannelController(e,n,a,l){console.log("$routeParams",e);const t=this;t.channelData=n(firebase.database().ref("Channels/"+e.channelId)),t.allChannels=n(firebase.database().ref("Channels")),t.engagementsData=l,t.newRLSelections={roleid:"",ledgerId:""},t.frequency={0:"Daily",1:"Weekly",2:"Bi-Weekly",3:"Monthly",4:"Yearly",5:"Other"},t.saveData=function(){t.channelData.$save().then(function(){console.log("data saved successfully")}).catch(function(e){console.log("Error Saving Data",e)})},t.rowClick=function(e){console.log(e),a.path("/admin/engagments/"+e)},t.sumEngagments=function(e){var n=0;return Object.keys(e).forEach(function(e){n=e.length}),n},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location","engagemnts"];
...
function minishopProductionController(n,o,t,e,r,a,i,s){let c=this;c.params=o;function d(r){Object.keys(c.txsSummary).forEach(function(n){const o=c.txsSummary[n];Object.keys(o).forEach(function(t){const e=o[t];Object.keys(e).forEach(function(o){e[o].id==r.roleId&&(c.txsSummary[n][t][o].value+=r.credit,c.txsSummary[n][t][o].value-=r.debit)})})})}function p(){if("Cooking"==c.prodReport.lastStatus){var o=i(c.prodReport.cooking.startAt);const t=i();c.batch.secElapsed=i.duration(t.diff(o)).as("seconds"),function(){var o=i(c.prodReport.cooking.startAt);const t=i();o=100*(i.duration(t.diff(o)).as("seconds")/1200).toFixed(2),c.batch.prcntPrgs=o}()}}c.channel=n(firebase.database().ref("Channels/"+o.channelId)),c.engagment=n(firebase.database().ref("Engagments/"+o.engmntId)),c.recipes=function(t){const e={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(e[o]=t[o])}),e}(a.models.operations),c.cookingList=[],c.txsList=[],c.batch={prcntPrgs:0,secElapsed:0},c.txsSummary={debits:{nuts:{pecans:{id:"-MmdFOUdWJKSaiY8qSBP",value:0},almonds:{id:"-Mnwy1lULD6uf9qPLb7w",value:0},cashews:{id:"-Mnwy9s4CdquFHL4EBpJ",value:0},hazelnuts:{id:"-MnwyPKyV9j1riq3z_Jv",value:0}},packaging:{pintcups:{id:"-Mo9ypVIJTf09YLBRGTd",value:0},pintLids:{id:"-Mo9yxhpuLbnJLqsjZfo",value:0},halfCups:{id:"-Mo9zUaMv11hJrJ4tref",value:0},halfLids:{id:"-Mo9zW4ShhozB04JDoh8",value:0},platTops:{id:"-Mo9zXdi2ZCUqPG6iTh-",value:0},platBots:{id:"-Mo9zYz8loLwGvu8fGB2",value:0}},cooking:{ssMix:{id:"-MjSoxKn1xrLk8L1b8PK",value:0},bbMix:{id:"-Mnv9B2Eip7PPZaN7aYa",value:0},salt:{id:"-MjSoxKn1xrLk8L1b8PK",value:0}},misc:{paperTowel:{id:"-Mo9zsxpeHi8estWW0bG",value:0},gasoline:{id:"-Mo9zo0gB2vNAwGThDbe",value:0}}},credits:{},balances:{"-MjSoxLGadkQpxtTuhCK":0,"-MnwvGpt6TTehfomFo18":0,"-MnwvK9M4P5v_9w_2cSa":22,"-MnwvNdZ2xqY2_8u9Ub7":0,"-MnvHa-65LfIp63akaI-":0,"-MnwvSTpy0dJAU5S_vgi":0,"-MnwvTh3Ax5g7KuZL8SB":0,"-MnwvXyu20U9VpKhWoJB":0,"-MjSoxKn1xrLk8L1b8PK":0,"-Mnv9B2Eip7PPZaN7aYa":0}},a.data.production.report.$bindTo(e,"vm.prodReport").then(function(){!function(){c.cookingList=[],null!=c.prodReport.journalEntries&&null!=c.prodReport.journalEntries||(c.prodReport.journalEntries={});Object.keys(c.prodReport.journalEntries).forEach(function(o){if("_hold"!=o){o="/JournalEntries/"+c.prodReport.journalEntries[o];const t=firebase.database();o=t.ref(o);c.cookingList.push(n(o))}})}(),function(){c.txsList=[],null!=c.prodReport.txs&&null!=c.prodReport.txs||(c.prodReport.txs={});Object.keys(c.prodReport.txs).forEach(function(o){if("_hold"!=o){o="Transactions/"+o;const t=firebase.database();o=t.ref(o),o=n(o).$loaded().then(function(o){d(o)});c.txsList.push(o)}})}()}),c.selectRecipe=function(o){var t=null==c.prodReport.ondeck.recipe,e=c.prodReport.ondeck.recipe==c.recipes[o].recipe&&c.prodReport.ondeck.nut==c.recipes[o].nut;(!t||e)&&(t||e)?!t&&e&&(c.prodReport.ondeck={_hold:""}):c.prodReport.ondeck=c.recipes[o]},c.startNewBatch=function(){null!=c.prodReport.ondeck.recipe?(c.prodReport.cooling=c.prodReport.cooking,c.prodReport.cooling.endAt=i().format(),c.prodReport.cooking=c.prodReport.ondeck,c.prodReport.lastStatus="Cooking",c.prodReport.cooking.startAt=i().format(),c.prodReport.cooking.expiresAt=i(c.prodReport.cooking.startAt).add(20,"minutes").format(),c.batch.secElapsed=0,a.production.journalBatchStart(c.prodReport).then(function(o){var t="JournalEntries/"+o.jeId;const e=firebase.database();t=e.ref(t),t=n(t);c.cookingList.push(t),c.prodReport.journalEntries[i().format()]=o.jeId,o.txIds.forEach(function(o){var t="Transactions/"+o;const e=firebase.database();t=e.ref(t),t=n(t).$loaded().then(function(o){d(o)});c.txsList.push(t),null!=c.prodReport.txs&&null!=c.prodReport.txs||(c.prodReport.txs={}),c.prodReport.txs[o]=o})}),c.prodReport.ondeck={_hold:""}):console.log("need to select a batch first")},c.calculateCookingDone=function(o){if(""==o)return"";{const t=i(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},c.calculateCookingError=function(o){},c.validatePercentProgress=function(o){return null==o||NaN==o?0:o},c.dateEnding=function(o){},console.log("in the miniship production controller "),t(function(){p()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$firebaseObject","$routeParams","$interval","$scope","$window","msData","moment","$http"];
