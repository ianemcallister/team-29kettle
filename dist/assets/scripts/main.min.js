...
function minishopPowerSourceController(o,e,a){var u=this;function r(){var o=a(new Date).hour(0).minute(0).second(0).format(),e=a(new Date).format(),r=[],n=[];r.push(o),u.txs.forEach(function(o){r.push(a(o.timestamp))}),r.push(e);for(let o=0;o<r.length;o++){var t=new a(r[o]);const c=new a(r[o+1]),i=a.duration(c.diff(t));var s=(i.as("seconds")/86399).toFixed(2),t={prcntg:100*s,classes:["progress-bar"]};console.log(o,i.as("seconds"),s),n.push(t)}return n}u.params=o,u.powerIsOn=!1,u.powerSource="generator",u.txs=[],u.timeBlocks=r(),u.toggleOnOff=function(){var o="off";u.powerIsOn||(o="on"),u.txs.push({timestamp:a(new Date).format(),source:u.powerSource,turning:o}),u.timeBlocks=r(),u.powerIsOn=!u.powerIsOn},console.log("in the power source controller ")}ckc.controller("minishopPowerSourceController",minishopPowerSourceController),minishopPowerSourceController.$inject=["$routeParams","MiniShop","moment"];
