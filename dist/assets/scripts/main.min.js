...
function minishopProductionController(e,o,t,n,c,i){let s=this;s.recipes=[{recipe:"Sweet & Salty",nut:"Pecans"},{recipe:"Sweet & Salty",nut:"Almonds"},{recipe:"Sweet & Salty",nut:"Cashews"},{recipe:"Sweet & Salty",nut:"Hazelnuts"},{recipe:"Bourbon",nut:"Pecans"},{recipe:"Bourbon",nut:"Almonds"},{recipe:"Bourbon",nut:"Cashews"},{recipe:"Bourbon",nut:"Hazelnuts"}],s.batches={ondeck:{},cooking:{},cooling:{}},s.cookingMetrics={startngTime:"",timeElapsed:0,status:"Off"},s.selectRecipe=function(e){var o=null==s.batches.ondeck.recipe,t=s.batches.ondeck.recipe==s.recipes[e].recipe&&s.batches.ondeck.nut==s.recipes[e].nut;(!o||t)&&(o||t)?!o&&t&&(s.batches.ondeck={}):s.batches.ondeck=s.recipes[e]},s.startNewBatch=function(){null!=s.batches.ondeck.recipe?(console.log("starting a new batch"),s.batches.cooling=s.batches.cooking,s.batches.cooking=s.batches.ondeck,s.cookingMetrics.status="Cooking",s.cookingMetrics.startngTime=i().format(),s.cookingMetrics.timeElapsed=0,s.batches.ondeck={}):console.log("ned to select a batch first")},console.log("in the miniship production controller "),o(function(){},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$routeParams","$interval","$scope","$window","msData","moment"];
