...
function adminABoMController(o,e,r){var l=this;const a=firebase.database();var n=a.ref("BOMs/"+e.bomId),e=a.ref("OpRoles");l.record=o(n),l.roleOptions=o(e),l.aNewResource={id:"",name:"",UoM:"",qty:""},console.log("in a bill of materials controller ")}ckc.controller("adminABoMController",adminABoMController),adminABoMController.$inject=["$firebaseObject","$routeParams","$scope"];
