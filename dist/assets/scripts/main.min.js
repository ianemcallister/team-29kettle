...
function dailyFundsCollected(){t.$inject=["scope","el","attr","ctrl"];var e={restrict:"AECM",templateUrl:"assets/views/directives/daily-funds-collected.htm",replace:!0,scope:{date:"="},link:t,controller:l,controllerAs:"vm",bindToController:!0};function t(l,e,t,c){l.$watch("date",function(e,t){l.vm.loadPayments(l.vm.date)})}function l(t,e,l){console.log("in the daily funds collected directive");this.paymentsCollected="",t.vm.loadPayments=function(e){l.get.dailyCollections(e).then(function(e){t.vm.paymentsCollected=e}).catch(function(e){console.log("error: ",e)})}}return l.$inject=["$scope","$log","Database"],e}ckc.directive("dailyFundsCollected",dailyFundsCollected);
