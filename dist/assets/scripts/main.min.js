...
function cookingRecorder(){t.$inject=["scope","el","attr","ctrl"];var e={restrict:"AECM",templateUrl:"assets/views/minishop/directives/cookingRecorder.htm",replace:!0,scope:{},link:t,controller:o,controllerAs:"vm",bindToController:!0};function t(e,t,o,i){}function o(){console.log("in the Cooking Recorder Directive");this.options={"1s09ugasoigas":{title:"",recipe:"Sweet & Salty",nut:"Pecans"},"paosjg;oiahwe":{title:"",recipe:"Sweet & Salty",nut:"Almonds"},pejsg09u2nssd:{title:"",recipe:"Sweet & Salty",nut:"Cashews"},"029ugojsdohbs":{title:"",recipe:"Sweet & Salty",nut:"Hazelnuts"},Moshdwebosi13:{title:"",recipe:"Bourbon",nut:"Pecans"},"923NGashigbsd":{title:"",recipe:"Bourbon",nut:"Almonds"},"jweoi2#9ssdgw":{title:"",recipe:"Bourbon",nut:"Cashews"},"2ANSgih3sh2#-":{title:"",recipe:"Bourbon",nut:"Hazelnuts"}}}return o.$inject=[],e}ckc.directive("cookingRecorder",cookingRecorder);
...
function MiniShop(){console.log("Loading Mini Shop Service");return this.engagment={},{_engagment:this.engagment,get:"",set:"",update:"",delete:""}}ckc.factory("MiniShop",MiniShop),MiniShop.$inject=[];
