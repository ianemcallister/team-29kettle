...
function config(e,t){t.hashPrefix(""),e.when("/",{redirectTo:"/member"}).when("/login",{templateUrl:"assets/views/login-page.htm",controller:"loginController",controllerAs:"vm"}).when("/member",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var l=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid):n.path("/login"),l.resolve()}),l.promise}]}}).when("/member/:uid",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var l=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid):n.path("/login"),l.resolve()}),l.promise}]}}).when("/member/:uid/settings",{templateUrl:"assets/views/acct-settings-page.htm",controller:"acctSettingsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var l=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/settings"):n.path("/login"),l.resolve()}),l.promise}]}}).when("/member/:uid/txs_assignments",{templateUrl:"assets/views/txs-assigments-page.htm",controller:"txsAssigmentsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var l=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/txs_assignments"):n.path("/login"),l.resolve()}),l.promise}]}}).when("/member/:uid/activities",{templateUrl:"assets/views/activities-page.htm",controller:"activitiesController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,n){var l=t.defer();return e.user().then(function(e){e?n.path("/member/"+e.uid+"/activities"):n.path("/login"),l.resolve()}),l.promise}]}}).when("/minishop/:engmntId/:channelId/",{templateUrl:"assets/views/minishop/mdashboard-page.htm",controller:"minishopDashController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/settings",{templateUrl:"assets/views/minishop/settings-page.htm",controller:"minishopStngsController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/production",{templateUrl:"assets/views/minishop/production-page.htm",controller:"minishopProductionController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/salesTxs",{templateUrl:"assets/views/minishop/sales-txs-page.htm",controller:"minishopSalesTxsController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/balanceSheet",{templateUrl:"assets/views/minishop/balancesheet-page.htm",controller:"minishopBalancesheetController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/power",{templateUrl:"assets/views/minishop/power-source-page.htm",controller:"minishopPowerSourceController",controllerAs:"vm"}).when("/admin/channels",{title:"Admin: Channels",templateUrl:"assets/views/admin/channels-page.htm",controller:"adminChannelsController",controllerAs:"vm"}).when("/admin/channels/:channelId",{title:"Admin: Channels",templateUrl:"assets/views/admin/select-channel-page.htm",controller:"adminSelectChannelController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,t,n){var l=t.defer();return e.get.channelEngagments(n.current.params.channelId).then(function(e){console.log("got this",e),l.resolve(e)}),l.promise}]}}).when("/admin/engagments/:engagmentId",{templateUrl:"assets/views/admin-select-engagment-page.htm",controller:"adminSelectEngagmentController",controllerAs:"vm"}).when("/admin/schedule/weekly",{templateUrl:"assets/views/admin-weekly-schedule-page.htm",controller:"adminWeeklyScheduleController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,t,n){console.log("routing: ",n.current.params.Wk);var l=t.defer();return e.get.weeklyEngagments(n.current.params.Wk).then(function(e){console.log("got this",e),l.resolve(e)}),l.promise}]}}).when("/admin/fundsAllocations/daily",{templateUrl:"assets/views/admin-funds-allocations-daily-page.htm",controller:"adminFundsAllocationsDailyController",controllerAs:"vm"}).when("/admin/accts",{title:"Admin: Accounts",templateUrl:"assets/views/admin/accts-manage-page.htm",controller:"adminAcctsManageController",controllerAs:"vm"}).when("/admin/BoM",{title:"Admin: Bill Of Materials",templateUrl:"assets/views/admin/bom-list-page.htm",controller:"adminBoMListController",controllerAs:"vm"}).when("/admin/BoM/:bomId",{title:"Admin: Bill Of Materials",templateUrl:"assets/views/admin/a-bom-page.htm",controller:"adminABoMController",controllerAs:"vm"}).when("/admin/operationRoles",{title:"Admin: Roles",templateUrl:"assets/views/admin/opRoles-list-page.htm",controller:"adminOpRolesListContoller",controllerAs:"vm"}).when("/admin/ledgers",{title:"Admin: Ledgers",templateUrl:"assets/views/admin/ledgers-list-page.htm",controller:"adminLedgerslistController",controllerAs:"vm"}).otherwise({redirectTo:"/"})}config.$inject=["$routeProvider","$locationProvider"],angular.module("ckc").config(config);
...
function adminOpRolesListContoller(e,o){var s=this;const t=firebase.database();var l=t.ref("OpRoles");s.opRolesList=e(l),s.currentRecord={name:"",UofM:"",description:"",notes:""},s.addSelection=function(){var e=firebase.database().ref().child("OpRoles").push().key;s.opRolesList[e]=s.currentRecord,s.opRolesList.$save().then(function(){console.log("saved successfully"),s.currentRecord={name:"",UoM:"",description:"",notes:""}})},console.log("in the op roles list controller ",s.opRolesList)}ckc.controller("adminOpRolesListContoller",adminOpRolesListContoller),adminOpRolesListContoller.$inject=["$firebaseObject","$scope"];
function adminSelectChannelController(e,n,l,a){console.log("$routeParams",e);var o=this;const t=firebase.database();var r=t.ref("Channels/"+e.channelId),c=t.ref("OpRoles"),e=t.ref("Ledgers");o.channelData=n(r),o.allRoles=n(c),o.allLedgers=n(e),o.engagementsData=a,o.rowClick=function(e){console.log(e),l.path("/admin/engagments/"+e)},o.sumEngagments=function(e){var n=0;return Object.keys(e).forEach(function(e){n=e.length}),n},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location","engagemnts"];
