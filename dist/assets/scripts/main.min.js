...
function minishopProductionController(o,t,e,n,r,i){let c=this;function s(){"Cooking"==c.cookingMetrics.status&&(c.cookingMetrics.timeElapsed++,function(){var o=i(c.cookingMetrics.startngTime);const t=i();o=100*(i.duration(t.diff(o)).as("seconds")/1200).toFixed(2),c.cookingMetrics.prcntPrgs=o}())}c.recipes=function(t){const e={};return Object.keys(t).forEach(function(o){"recipe"==t[o].type&&(e[o]=t[o])}),e}(r.models.operations),c.cookingMetrics={startngTime:"",expiresAt:"",timeElapsed:0,status:"Off",prcntPrgs:0},r.data.production.report.$bindTo(e,"vm.prodReport").then(function(){}),c.selectRecipe=function(o){var t=null==c.prodReport.ondeck.recipe,e=c.prodReport.ondeck.recipe==c.recipes[o].recipe&&c.prodReport.ondeck.nut==c.recipes[o].nut;(!t||e)&&(t||e)?!t&&e&&(c.prodReport.ondeck={_hold:""}):c.prodReport.ondeck=c.recipes[o]},c.startNewBatch=function(){null!=c.prodReport.ondeck.recipe?(console.log("starting a new batch"),c.prodReport.cooling=c.prodReport.cooking,c.prodReport.cooking=c.prodReport.ondeck,c.cookingMetrics.status="Cooking",c.cookingMetrics.startngTime=i().format(),c.cookingMetrics.timeElapsed=0,c.prodReport.ondeck={_hold:""}):console.log("ned to select a batch first")},c.calculateCookingDone=function(o){if(""==o)return"";{const t=i(o);return t.add(12,"minutes").format("h:mm a")+" - "+t.add(16,"minutes").format("h:mm a")}},c.calculateCookingError=function(o){},console.log("in the miniship production controller "),t(function(){s()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$routeParams","$interval","$scope","$window","msData","moment"];
