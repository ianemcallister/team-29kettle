"use strict";var ckc=angular.module("ckc",["ngRoute","ngSanitize","firebase","720kb.datepicker","angularMoment"]);
...
function adminAcctsManageController(){console.log();console.log("in the Admin ACcounts Manager controller ")}ckc.controller("adminAcctsManageController",adminAcctsManageController),adminAcctsManageController.$inject=[];
...
function config(e,n){n.hashPrefix(""),e.when("/",{redirectTo:"/member"}).when("/login",{templateUrl:"assets/views/login-page.htm",controller:"loginController",controllerAs:"vm"}).when("/member",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,n,t){var r=n.defer();return e.user().then(function(e){e?t.path("/member/"+e.uid):t.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,n,t){var r=n.defer();return e.user().then(function(e){e?t.path("/member/"+e.uid):t.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid/settings",{templateUrl:"assets/views/acct-settings-page.htm",controller:"acctSettingsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,n,t){var r=n.defer();return e.user().then(function(e){e?t.path("/member/"+e.uid+"/settings"):t.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid/txs_assignments",{templateUrl:"assets/views/txs-assigments-page.htm",controller:"txsAssigmentsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,n,t){var r=n.defer();return e.user().then(function(e){e?t.path("/member/"+e.uid+"/txs_assignments"):t.path("/login"),r.resolve()}),r.promise}]}}).when("/member/:uid/activities",{templateUrl:"assets/views/activities-page.htm",controller:"activitiesController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,n,t){var r=n.defer();return e.user().then(function(e){e?t.path("/member/"+e.uid+"/activities"):t.path("/login"),r.resolve()}),r.promise}]}}).when("/minishop/:engmntId/:channelId/",{templateUrl:"assets/views/minishop/mdashboard-page.htm",controller:"minishopDashController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/settings",{templateUrl:"assets/views/minishop/settings-page.htm",controller:"minishopStngsController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/production",{templateUrl:"assets/views/minishop/production-page.htm",controller:"minishopProductionController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/salesTxs",{templateUrl:"assets/views/minishop/sales-txs-page.htm",controller:"minishopSalesTxsController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/balanceSheet",{templateUrl:"assets/views/minishop/balancesheet-page.htm",controller:"minishopBalancesheetController",controllerAs:"vm"}).when("/minishop/:engmntId/:channelId/power",{templateUrl:"assets/views/minishop/power-source-page.htm",controller:"minishopPowerSourceController",controllerAs:"vm"}).when("/admin/channels",{templateUrl:"assets/views/admin-channels-page.htm",controller:"adminChannelsController",controllerAs:"vm"}).when("/admin/channels/:channelId",{templateUrl:"assets/views/admin-select-channel-page.htm",controller:"adminSelectChannelController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,n,t){var r=n.defer();return e.get.channelEngagments(t.current.params.channelId).then(function(e){console.log("got this",e),r.resolve(e)}),r.promise}]}}).when("/admin/engagments/:engagmentId",{templateUrl:"assets/views/admin-select-engagment-page.htm",controller:"adminSelectEngagmentController",controllerAs:"vm"}).when("/admin/schedule/weekly",{templateUrl:"assets/views/admin-weekly-schedule-page.htm",controller:"adminWeeklyScheduleController",controllerAs:"vm",resolve:{engagemnts:["Database","$q","$route",function(e,n,t){console.log("routing: ",t.current.params.Wk);var r=n.defer();return e.get.weeklyEngagments(t.current.params.Wk).then(function(e){console.log("got this",e),r.resolve(e)}),r.promise}]}}).when("/admin/fundsAllocations/daily",{templateUrl:"assets/views/admin-funds-allocations-daily-page.htm",controller:"adminFundsAllocationsDailyController",controllerAs:"vm"}).when("/admin/accts",{templateUrl:"assets/views/admin-accts-manage-page.htm",controller:"adminAcctsManageController",controllerAs:"vm"}).otherwise({redirectTo:"/"})}config.$inject=["$routeProvider","$locationProvider"],angular.module("ckc").config(config);
