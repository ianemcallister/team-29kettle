...
function adminSelectChannelController(e,n,a){console.log("$routeParams",e);var l,o=this;o.channelData=(l="Channels/"+(l=e.channelId),l=firebase.database().ref(l),n(l)),o.engagementsData={aiohgoihwes:{Yr:21,Wk:42,D:6,date:"2021-10-17"},osihaweo:{Yr:21,Wk:43,D:6,date:"2021-10-24"}},o.rowClock=function(e){console.log(e)},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location"];
function adminSelectEngagmentController(e,n,t){console.log("$routeParams",e);var o;this.engagmentData=(o="Engagments/"+(o=e.engagmentId),o=firebase.database().ref(o),n(o)),this.rowClock=function(e){console.log(e)},console.log("in the admin engagment channel controller ")}ckc.controller("adminSelectEngagmentController",adminSelectEngagmentController),adminSelectEngagmentController.$inject=["$routeParams","$firebaseObject","$location"];
