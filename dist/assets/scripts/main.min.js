...
function adminSelectChannelController(e,n,l,a){console.log("$routeParams",e);const o=this,t=firebase.database();var r=t.ref("Channels/"+e.channelId),c=t.ref("OpRoles"),e=t.ref("Ledgers");o.channelData=n(r),o.allRoles=n(c),o.allLedgers=n(e),o.engagementsData=a,o.newRLSelections={roleid:"",ledgerId:""},o.addRLMap=function(e){console.log("adding role Ledger map",e),o.channelData.ledgersMap[e.roleid]=e.ledgerId,o.channelData.$save().then(function(){console.log("RL Map saved sucessfully"),o.newRLSelections={roleid:"",ledgerId:""}})},o.rowClick=function(e){console.log(e),l.path("/admin/engagments/"+e)},o.sumEngagments=function(e){var n=0;return Object.keys(e).forEach(function(e){n=e.length}),n},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location","engagemnts"];
