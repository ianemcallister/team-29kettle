...
function adminSelectChannelController(e,n){console.log("$routeParams",e);var l;this.channelData=(l=firebase.database().ref("Channels/"),n(l)),console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminChannelsController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject"];
