...
function msData(o,t,e,u){var s=this;s.data={power:{isOn:n("Engagments/"+e.engmntId+"/power/isOn"),source:n("Engagments/"+e.engmntId+"/power/source"),txs:n("Engagments/"+e.engmntId+"/power/txs"),opSeconds:{generator:{continous:0,total:0},house:{continous:0,total:0}},timeBlocks:[]}};e={data:s.data,power:{togglePower:function(){console.log("toggling power"),s.data.power.isOn.$value=!s.data.power.isOn.$value;var o=u().format();s.data.power.txs[u().format("x")]={timestamp:o,source:s.data.power.source.$value,turningOn:s.data.power.isOn.$value},s.data.power.txs.$save();o=a(s.data.power.txs,s.data.power.opSeconds);s.data.power.timeblocks=o.timeblocks,s.data.power.opSeconds=o.opSconds},getPowerKPIs:a}};function n(o){o=firebase.database().ref(o);return t(o)}function l(o){let t=!1;return null!=o.turning&&"on"==o.turning&&(t=!0),t}function a(o,t){const e={timeblocks:[],opSconds:t},s=function(t){const e={};return Object.keys(t).forEach(function(o){"$$conf"!=o&&"$id"!=o&&"$priority"!=o&&"$resolved"!=o&&(e[o]=t[o])}),e}(o),n=[];t.generator.total=0,t.generator.continous=0,t.house.total=0,t.house.continous=0;t=u().format();s[t]={timestamp:t},Object.keys(s).forEach(function(o){n.push(o)});for(let o=0;o<n.length-1;o++){var a=n[o],r=n[o+1],c=u(s[a].timestamp);const i=u(s[r].timestamp),d=u.duration(i.diff(c)),p={prcntg:100*(d.as("seconds")/86399).toFixed(2),seconds:d.as("seconds"),isOn:l(s[a]),classes:["progress-bar"]};console.log("progressObject",p),p.isOn&&p.classes.push("bg-warning"),l(s[a])&&null!=e.opSeconds&&(e.opSeconds.house.total+=d.as("seconds"),e.opSeconds.house.continous=d.as("seconds")),e.timeblocks.push(p)}return e}return o(function(){var o=a(s.data.power.txs,s.data.power.opSeconds);s.data.power.timeblocks=o.timeblocks,s.data.power.opSeconds=o.opSconds},1e4),e}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","moment"];
...
function minishopPowerSourceController(o,e,r,n){var t=this;e.Math=window.Math,t.params=o,r.data.power.isOn.$bindTo(e,"vm.powerIsOn"),r.data.power.source.$bindTo(e,"vm.powerSource"),r.data.power.txs.$bindTo(e,"vm.txs"),t.opSeconds=r.data.power.opSeconds,t.timeBlocks=r.data.power.timeBlocks,t.toggleOnOff=function(){r.power.togglePower()},console.log("in the power source controller ")}ckc.controller("minishopPowerSourceController",minishopPowerSourceController),minishopPowerSourceController.$inject=["$routeParams","$scope","msData","moment"];
function minishopProdTxsController(){console.log("in the miniship production transactions controller ")}ckc.controller("minishopProdTxsController",minishopProdTxsController),minishopProdTxsController.$inject=[];
