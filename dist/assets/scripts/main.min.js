...
function adminSelectEngagmentController(n,e,t,a){console.log("$routeParams",n);var o=this;o.engagmentData=e(firebase.database().ref("Engagments/"+n.engagmentId)),o.routeParams=n,o.channelClicked=function(n){console.log(n),t.path("/admin/channels/"+n)},o.dateConcatenate=function(n,e){const t=a();if(null!=n&&null!=e){n=n.split("-");const o=e.split("-");e=o[0].split(":");t.year(n[2]).month(n[0]-1).date(n[1]).hour(e[0]).minute(e[1]).second(e[2])}return t.format()},o.yrWkDConcatenate=function(n,e,t){if(null!=n&&null!=e&&null!=t)return n.toString()+e.toString()+t.toString()},console.log("in the admin engagment channel controller ")}ckc.controller("adminSelectEngagmentController",adminSelectEngagmentController),adminSelectEngagmentController.$inject=["$routeParams","$firebaseObject","$location","moment"];
