...
function msData(a,e,t,o,r){var n=this;function s(a){a=firebase.database().ref(a);return e(a)}return n.data={power:{isOn:s("Engagments/"+t.engmntId+"/power/isOn"),source:s("Engagments/"+t.engmntId+"/power/source"),txs:s("Engagments/"+t.engmntId+"/power/txs")}},{data:n.data,power:{togglePower:function(){console.log("toggling power"),n.data.power.isOn.$value=!n.data.power.isOn.$value;var a=r().format();n.data.power.txs[r().format("x")]={timestamp:a,source:n.data.power.source.$value,turningOn:n.data.power.isOn.$value},n.data.power.isOn.$save(),n.data.power.txs.$save(),o.$broadcast("powerTxsLoaded",n.data.power.txs)}}}}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","$rootScope","moment"];
...
function minishopProductionController(e,o,t,n,c,i){let s=this;function r(){"Cooking"==s.cookingMetrics.status&&(s.cookingMetrics.timeElapsed++,function(){var e=i(s.cookingMetrics.startngTime);const o=i();e=100*(i.duration(o.diff(e)).as("seconds")/1200).toFixed(2),s.cookingMetrics.prcntPrgs=e}())}s.recipes=[{recipe:"Sweet & Salty",nut:"Pecans"},{recipe:"Sweet & Salty",nut:"Almonds"},{recipe:"Sweet & Salty",nut:"Cashews"},{recipe:"Sweet & Salty",nut:"Hazelnuts"},{recipe:"Bourbon",nut:"Pecans"},{recipe:"Bourbon",nut:"Almonds"},{recipe:"Bourbon",nut:"Cashews"},{recipe:"Bourbon",nut:"Hazelnuts"}],s.batches={ondeck:{},cooking:{},cooling:{}},s.cookingMetrics={startngTime:"",timeElapsed:0,status:"Off",prcntPrgs:0},s.selectRecipe=function(e){var o=null==s.batches.ondeck.recipe,t=s.batches.ondeck.recipe==s.recipes[e].recipe&&s.batches.ondeck.nut==s.recipes[e].nut;(!o||t)&&(o||t)?!o&&t&&(s.batches.ondeck={}):s.batches.ondeck=s.recipes[e]},s.startNewBatch=function(){null!=s.batches.ondeck.recipe?(console.log("starting a new batch"),s.batches.cooling=s.batches.cooking,s.batches.cooking=s.batches.ondeck,s.cookingMetrics.status="Cooking",s.cookingMetrics.startngTime=i().format(),s.cookingMetrics.timeElapsed=0,s.batches.ondeck={}):console.log("ned to select a batch first")},s.calculateCookingDone=function(e){if(""==e)return"";{const o=i(e);return o.add(12,"minutes").format("h:mm a")+" - "+o.add(16,"minutes").format("h:mm a")}},s.calculateCookingError=function(e){},console.log("in the miniship production controller "),o(function(){r()},1e3)}ckc.controller("minishopProductionController",minishopProductionController),minishopProductionController.$inject=["$routeParams","$interval","$scope","$window","msData","moment"];
