...
function engagmentProjetionsController(n,e,o,t){console.log("in the engagment projections  controller ",n);var r=this;t.loadDirectObject("Engagments",n.engagmentId).then(function(n){n.$bindTo(o,"vm.engagment")}).catch(function(n){console.log("engagments error",n)}),t.loadChildObject("Projections","id",n.engagmentId).then(function(n){n.$bindTo(o,"vm.projections")}).catch(function(n){console.log("projections error",n)}),r.user=firebase.auth().currentUser,r.routeParams=n,r.updateRev=function(n){console.log("changing type",n)},r.weekNum=function(n,e,o){let t="";return null!=n&&null!=e&&null!=o&&(t=e.toString()+n.toString().padStart(2,"0")+o.toString()),t}}ckc.controller("engagmentProjetionsController",engagmentProjetionsController),engagmentProjetionsController.$inject=["$routeParams","$firebaseObject","$scope","data"];