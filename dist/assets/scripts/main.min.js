...
function msData(a,t,e,o,r){var n=this;n.data={power:{isOn:s("Engagments/"+e.engmntId+"/power/isOn"),source:s("Engagments/"+e.engmntId+"/power/source"),txs:s("Engagments/"+e.engmntId+"/power/txs")}};e={data:n.data,power:{togglePower:function(){console.log("toggling power"),n.data.power.isOn.$value=!n.data.power.isOn.$value;var a=r().format();n.data.power.txs[r().format("x")]={timestamp:a,source:n.data.power.source.$value,turningOn:n.data.power.isOn.$value},n.data.power.isOn.$save(),n.data.power.txs.$save(),o.$broadcast("powerTxsLoaded",n.data.power.txs)}}};function s(a){a=firebase.database().ref(a);return t(a)}return n.data.power.txs.$loaded().then(function(a){o.$broadcast("powerTxsLoaded",n.data.power.txs)}).catch(function(a){}),e}ckc.factory("msData",msData),msData.$inject=["$interval","$firebaseObject","$routeParams","$rootScope","moment"];
...
function minishopPowerSourceController(o,n,e,s,p){let t=this;function c(o,n){n=function(o,n){const e={timeblocks:[],opSeconds:n},s=function(n){const e={};return Object.keys(n).forEach(function(o){"$$conf"!=o&&"$id"!=o&&"$priority"!=o&&"$resolved"!=o&&(e[o]=n[o])}),e}(o),t=[];e.opSeconds.generator.total=0,e.opSeconds.generator.continous=0,e.opSeconds.house.total=0,e.opSeconds.house.continous=0;o=p().format();s[o]={timestamp:o},Object.keys(s).forEach(function(o){t.push(o)});for(let o=0;o<t.length-1;o++){var c=t[o],r=t[o+1],i=p(s[c].timestamp);const a=p(s[r].timestamp),l=p.duration(a.diff(i)),u={prcntg:100*(l.as("seconds")/86399).toFixed(2),seconds:l.as("seconds"),isOn:d(s[c]),classes:["progress-bar"]};u.isOn&&u.classes.push("bg-warning"),console.log(s[c],d(s[c])),d(s[c])&&null!=e.opSeconds&&(e.opSeconds.house.total+=l.as("seconds"),e.opSeconds.house.continous=l.as("seconds")),e.timeblocks.push(u)}return e}(o,n);t.timeblocks=n.timeblocks,t.opSeconds=n.opSeconds}function d(o){let n=!1;return null!=o.turningOn&&o.turningOn&&(n=!0),n}e.Math=window.Math,t.params=n,t.opSeconds={house:{total:0,continous:0},generator:{total:0,continous:0}},t.timeblocks=[],s.data.power.isOn.$bindTo(e,"vm.powerIsOn"),s.data.power.source.$bindTo(e,"vm.powerSource"),s.data.power.txs.$bindTo(e,"vm.txs"),t.toggleOnOff=function(){s.power.togglePower()},console.log("in the power source controller "),e.$on("powerTxsLoaded",function(o,n){c(n,t.opSeconds)}),o(function(){c(t.txs,t.opSeconds)},1e4)}ckc.controller("minishopPowerSourceController",minishopPowerSourceController),minishopPowerSourceController.$inject=["$interval","$routeParams","$scope","msData","moment"];
