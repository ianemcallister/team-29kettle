...
function listOfChannels(){n.$inject=["scope","el","attr","ctrl"];var e={restrict:"AECM",templateUrl:"assets/views/directives/list-of-channels.htm",replace:!0,scope:{channels:"="},link:n,controller:t,controllerAs:"vm",bindToController:!0};function n(e,n,t,s){e.$watch("vm.channels",function(e,n){})}function t(e){this.sortBy="name",this.sortedChannels=[],console.log("in the list of channels directive",e)}return t.$inject=["$scope"],e}ckc.directive("listOfChannels",listOfChannels);
...
function data(f,s){function d(n,c){return new Promise(function(o,e){s.add(n+"/"+c,{id:c}).then(function(e){console.log("Reocrd created"),o()}).catch(function(e){console.log("error",e)})})}return{_createNewRecord:d,loadDirectObject:function(o,n){var t=o+"/"+n,r=firebase.database().ref(t);return new Promise(function(o,n){var c;c=t,new Promise(function(o,e){s.read(c).then(function(e){console.log("got this record back",e),o(e)}).catch(function(e){console.log("Error",e)})}).then(function(){o(f(r))}).catch(function(){console.log("error",e)})})},loadChildObject:function(l,a,i){let u=firebase.database().ref(l).orderByChild(a).equalTo(i);return new Promise(function(o,n){var c,t,r;c=l,t=a,r=i,new Promise(function(o,e){s.query.child(c,t,r).then(function(e){console.log("got this Query record back",e),null==e?d(c,r).then(function(e){o()}).catch(function(e){console.log("Error",e)}):o()}).catch(function(e){console.log("Error",e)})}).then(function(){o(f(u))}).catch(function(){console.log("error",e)})})},loadFBObject:function(e,o,c,t){console.log("loading firebase object",e,o,c,t);let n=e;null!=o&&(n+="/"+o);let r=firebase.database().ref(n),l="";return new Promise(function(o,e){var n;l=null!=c&&null!=t?(n=r.orderByChild(c).equalTo(t),f(n)):f(r),l.$loaded().then(function(e){console.log("success",Object.keys(e).length,t,e),Object.keys(e).length<6&&null==e.$value&&(console.log("no record found here",l),l.$value=null,l.id=t),o(l)}).catch(function(e){console.log("Error",e)})})}}}ckc.factory("data",data),data.$inject=["$firebaseObject","Firebase"];
...
function engagmentProjetionsController(e,n,o,t){console.log("in the engagment projections  controller ",e);var r=this;t.loadDirectObject("Engagments",e.engagmentId).then(function(e){e.$bindTo(o,"vm.engagment")}).catch(function(e){console.log("engagments error",e)}),t.loadChildObject("Projections","id",e.engagmentId).then(function(e){e.$bindTo(o,"vm.projections")}).catch(function(e){console.log("projections error",e)}),r.user=firebase.auth().currentUser,r.routeParams=e,r.data={revType:"",revValue:0},r.updateRev=function(e){console.log("changing type",e)},r.weekNum=function(e,n,o){console.log("calculating weeknum",e,n,o);let t="";return null!=e&&null!=n&&null!=o&&(t=n.toString()+e.toString().padStart(2,"0")+o.toString()),t}}ckc.controller("engagmentProjetionsController",engagmentProjetionsController),engagmentProjetionsController.$inject=["$routeParams","$firebaseObject","$scope","data"];