...
function adminSelectChannelController(n,e,a,l){console.log("$routeParams",n);var o,t=this;l.get.channelEngagments(n.channelId).then(function(n){t.engagementsData=n}),t.channelData=(o="Channels/"+(o=n.channelId),o=firebase.database().ref(o),e(o)),t.rowClick=function(n){console.log(n)},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location","Database"];
...
function Database(t,a){return{get:{channelEngagments:function(n){console.log("GetChannelEngagments: ",n);var e=t.defer();return a({method:"GET",url:"/db/engagments?channelId="+n}).then(function(n){console.log("got this response"),console.log(n.data)},function(n){console.log("Error: ",n)}),e.promise}}}}ckc.factory("Database",Database),Database.$inject=["$q","$http"];
...
function config(e,t){t.hashPrefix(""),e.when("/",{redirectTo:"/member"}).when("/login",{templateUrl:"assets/views/login-page.htm",controller:"loginController",controllerAs:"vm"}).when("/member",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,r){var n=t.defer();return e.user().then(function(e){e?r.path("/member/"+e.uid):r.path("/login"),n.resolve()}),n.promise}]}}).when("/member/:uid",{templateUrl:"assets/views/dashboard-page.htm",controller:"dashboardController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,r){var n=t.defer();return e.user().then(function(e){e?r.path("/member/"+e.uid):r.path("/login"),n.resolve()}),n.promise}]}}).when("/member/:uid/settings",{templateUrl:"assets/views/acct-settings-page.htm",controller:"acctSettingsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,r){var n=t.defer();return e.user().then(function(e){e?r.path("/member/"+e.uid+"/settings"):r.path("/login"),n.resolve()}),n.promise}]}}).when("/member/:uid/txs_assignments",{templateUrl:"assets/views/txs-assigments-page.htm",controller:"txsAssigmentsController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,r){var n=t.defer();return e.user().then(function(e){e?r.path("/member/"+e.uid+"/txs_assignments"):r.path("/login"),n.resolve()}),n.promise}]}}).when("/member/:uid/activities",{templateUrl:"assets/views/activities-page.htm",controller:"activitiesController",controllerAs:"vm",resolve:{user:["State","$q","$location",function(e,t,r){var n=t.defer();return e.user().then(function(e){e?r.path("/member/"+e.uid+"/activities"):r.path("/login"),n.resolve()}),n.promise}]}}).when("/admin/channels",{templateUrl:"assets/views/admin-channels-page.htm",controller:"adminChannelsController",controllerAs:"vm"}).when("/admin/channels/:channelId",{templateUrl:"assets/views/admin-select-channel-page.htm",controller:"adminSelectChannelController",controllerAs:"vm"}).when("/admin/engagments/:engagmentId",{templateUrl:"assets/views/admin-select-engagment-page.htm",controller:"adminSelectEngagmentController",controllerAs:"vm"}).otherwise({redirectTo:"/"})}config.$inject=["$routeProvider","$locationProvider"],angular.module("ckc").config(config);
