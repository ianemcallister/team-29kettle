"use strict";var ckc=angular.module("ckc",["ngRoute","ngSanitize","firebase","720kb.datepicker"]);
...
function adminSelectChannelController(e,n,a,l){console.log("$routeParams",e);var o,t=this;t.channelData=(o="Channels/"+(o=e.channelId),o=firebase.database().ref(o),n(o)),t.engagementsData=l,t.rowClick=function(e){console.log(e),a.path("/admin/engagments/"+e)},console.log("in the admin select channel controller ")}ckc.controller("adminSelectChannelController",adminSelectChannelController),adminSelectChannelController.$inject=["$routeParams","$firebaseObject","$location","engagemnts"];
