...
function breadcrumbs(){r.$inject=["scope","el","attr","ctrl"];var e={restrict:"AECM",templateUrl:"assets/views/directives/breadcrumbs.htm",replace:!0,scope:{previous:"=",current:"@"},link:r,controller:c,controllerAs:"vm",bindToController:!0};function r(e,r,c,t){}function c(e){console.log("in the breadcrumbs directive",e)}return c.$inject=["$scope"],e}ckc.directive("breadcrumbs",breadcrumbs);
...
function engSalesProjActlComp(){t.$inject=["scope","el","attr","ctrl"];var e={restrict:"AECM",templateUrl:"assets/views/directives/engagment-SPA-Comp.htm",replace:!0,scope:{engagments:"="},link:t,controller:n,controllerAs:"vm",bindToController:!0};function t(n,e,t,o){n.$watch("engagments",function(e,t){Object.keys(n.vm.engagments).forEach(function(e){n.vm.engagments[e].engagmentId=e,n.vm.engagmentsList.push(n.vm.engagments[e])}),n.vm.engagmentsList.sort(function(e,t){e=moment(e.date),t=moment(t.date);return t<e?-1:e<t?1:0}),n.vm.buildReportsList()})}function n(t,n){console.log("in the engSalesProjActlCompController directive");var o=this;o.engagmentsList=[],o.reports=[],o.weekNum=function(e,t,n){let o="";return null!=e&&null!=t&&null!=n&&(o=t.toString()+e.toString().padStart(2,"0")+n.toString()),o},o.rowClick=function(e){console.log(e),t.path("/admin/engagments/"+e)},o.buildReportsList=function(){o.engagmentsList.forEach(function(e){o.reports.push(n(firebase.database().ref("Reports/"+e.engagmentId)))})}}return n.$inject=["$location","$firebaseObject"],e}ckc.directive("engSalesProjActlComp",engSalesProjActlComp);
...
function listOfChannels(){e.$inject=["scope","el","attr","ctrl"];var n={restrict:"AECM",templateUrl:"assets/views/directives/list-of-channels.htm",replace:!0,scope:{channels:"="},link:e,controller:t,controllerAs:"vm",bindToController:!0};function e(n,e,t,l){n.$watch("vm.channels",function(n,e){})}function t(n,e){var t=this;t.sortBy="name",t.sortedChannels=[],t.rowClicked=function(n){e.path("/admin/channels/"+n)},console.log("in the list of channels directive",n)}return t.$inject=["$scope","$location"],n}ckc.directive("listOfChannels",listOfChannels);
...
function Firebase(){return this.data=["one","two"],console.log("Firebase Service"),{add:function(e,r){return new Promise(function(n,o){firebase.database().ref(e).set(r,function(e){e?(console.log("Write Error",e),o()):(console.log("Write Successful"),n())})})},read:function(e){console.log("reading",e);const o=firebase.database().ref(e);return new Promise(function(n,e){o.on("value",function(e){e=e.val();n(e)})})},update:function(e){return new Promise(function(n,o){firebase.database().ref().update(e,function(e){e?(console.log("Firebase Update Error",e),o()):n()})})},query:{child:function(e,n,o){const r=firebase.database().ref(e),a=r.orderByChild(n).equalTo(o);return new Promise(function(n,e){a.on("value",function(e){e=e.val();n(e)})})}}}}ckc.factory("Firebase",Firebase),Firebase.$inject=[];
...
function data(f,s){function d(o,c){return new Promise(function(n,e){s.add(o+"/"+c,{id:c}).then(function(e){console.log("Reocrd created"),n()}).catch(function(e){console.log("error",e)})})}return{_createNewRecord:d,loadDirectObject:function(n,o){var t=n+"/"+o,r=firebase.database().ref(t);return new Promise(function(n,o){var c;c=t,new Promise(function(n,e){s.read(c).then(function(e){n(e)}).catch(function(e){console.log("Error",e)})}).then(function(){n(f(r))}).catch(function(){console.log("error",e)})})},loadChildObject:function(l,a,i){let u=firebase.database().ref(l+"/"+i);return new Promise(function(n,o){var c,t,r;c=l,t=a,r=i,new Promise(function(n,e){s.query.child(c,t,r).then(function(e){null==e?d(c,r).then(function(e){n()}).catch(function(e){console.log("Error",e)}):n()}).catch(function(e){console.log("Error",e)})}).then(function(){n(f(u))}).catch(function(){console.log("error",e)})})},loadFBObject:function(e,n,c,t){console.log("loading firebase object",e,n,c,t);let o=e;null!=n&&(o+="/"+n);let r=firebase.database().ref(o),l="";return new Promise(function(n,e){var o;l=null!=c&&null!=t?(o=r.orderByChild(c).equalTo(t),f(o)):f(r),l.$loaded().then(function(e){console.log("success",Object.keys(e).length,t,e),Object.keys(e).length<6&&null==e.$value&&(console.log("no record found here",l),l.$value=null,l.id=t),n(l)}).catch(function(e){console.log("Error",e)})})}}}ckc.factory("data",data),data.$inject=["$firebaseObject","Firebase"];
...
function engagmentReportsController(e,t,n,r){console.log("in the engagment REPORTS  controller ",e);var o=this;r.loadDirectObject("Engagments",e.engagmentId).then(function(e){e.$bindTo(n,"vm.engagment")}).catch(function(e){console.log("engagments error",e)}),r.loadChildObject("Reports","id",e.engagmentId).then(function(e){e.$bindTo(n,"vm.reports")}).catch(function(e){console.log("reports error",e)}),o.user=firebase.auth().currentUser,o.routeParams=e,o.teamMembers=t(firebase.database().ref("Members")),o.weekNum=function(e,t,n){let r="";return null!=e&&null!=t&&null!=n&&(r=t.toString()+e.toString().padStart(2,"0")+n.toString()),r}}ckc.controller("engagmentReportsController",engagmentReportsController),engagmentReportsController.$inject=["$routeParams","$firebaseObject","$scope","data"];
function engagmentProjetionsController(e,o,t,n){console.log("in the engagment projections  controller ",e);let r=this;n.loadDirectObject("Engagments",e.engagmentId).then(function(e){e.$bindTo(t,"vm.engagment")}).catch(function(e){console.log("engagments error",e)}),n.loadChildObject("Projections","id",e.engagmentId).then(function(e){e.$bindTo(t,"vm.projections")}).catch(function(e){console.log("projections error",e)}),r.user=firebase.auth().currentUser,r.routeParams=e,r.updateRev=function(e){console.log("changing type",e)},r.weekNum=function(e,o,t){let n="";return null!=e&&null!=o&&null!=t&&(n=o.toString()+e.toString().padStart(2,"0")+t.toString()),n},r.evaluateExpense=function(e,o){switch(console.log("evaluting Exenses"),e){case"procVal":r.projections.procVal=r.projections.procRate/100*r.projections.revValue;break;case"rentType":r.projections.rentValue=o;break;case"cogRate":r.projections.cogValue=o/100*r.projections.revValue;break;case"laborType":r.projections.laborVal=o;break;case"commType":r.projections.commValue=o/100*r.projections.revValue;break;case"discRate":r.projections.discValue=o/100*r.projections.revValue}r.projections.expTotal=parseFloat(r.projections.procVal)+parseFloat(r.projections.rentValue)+parseFloat(r.projections.cogValue)+parseFloat(r.projections.laborVal)+parseFloat(r.projections.commValue)+parseFloat(r.projections.discValue),function(){null==r.projections.profit&&(r.projections.profit={value:0,percentage:0});r.projections.profit.value=r.projections.revValue-r.projections.expTotal,r.projections.profit.percentage=r.projections.profit.value/r.projections.revValue}()}}ckc.controller("engagmentProjetionsController",engagmentProjetionsController),engagmentProjetionsController.$inject=["$routeParams","$firebaseObject","$scope","data"];
