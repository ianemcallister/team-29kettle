...
function minishopPowerSourceController(o,r,e){var n=this;n.params=o,n.powerIsOn=!1,n.powerSource="generator",n.txs=[],n.toggleOnOff=function(){n.txs.push({timestamp:e(new Date).format()}),n.powerIsOn=!n.powerIsOn},console.log("in the power source controller ")}ckc.controller("minishopPowerSourceController",minishopPowerSourceController),minishopPowerSourceController.$inject=["$routeParams","MiniShop","moment"];
